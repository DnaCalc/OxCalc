...
| `archive/test-runs-core-engine-w038-w045/release-grade-ledger/w039-residual-successor-obligation-ledger-001/successor_obligation_ledger.json` | machine-readable W039 obligation owners and promotion consequences |
...
| `archive/test-runs-core-engine-w038-w045/implementation-conformance/w038-optimized-core-conformance-disposition-001/w038_exact_remaining_blocker_register.json` | four W038 exact remaining blockers |
| `archive/test-runs-core-engine-w038-w045/implementation-conformance/w038-optimized-core-conformance-disposition-001/w038_match_promotion_guard.json` | zero W038 match promotions |
| `archive/test-runs-core-engine-w038-w045/release-grade-ledger/w039-residual-successor-obligation-ledger-001/w073_formatting_intake.json` | W073 typed-only formatting guard retained as seam context |
...
| Artifact | Result |
|---|---|
| `archive/test-runs-core-engine-w038-w045/implementation-conformance/w039-optimized-core-exact-blocker-disposition-001/run_summary.json` | records 5 W039 disposition rows, 2 direct-evidence rows, 4 exact blockers, 0 match-promoted rows, and 0 failed rows |
| `archive/test-runs-core-engine-w038-w045/implementation-conformance/w039-optimized-core-exact-blocker-disposition-001/w039_exact_blocker_disposition_register.json` | machine-readable disposition rows binding W039 obligations to W038 exact blockers |
| `archive/test-runs-core-engine-w038-w045/implementation-conformance/w039-optimized-core-exact-blocker-disposition-001/w039_exact_remaining_blocker_register.json` | four retained exact blockers and owner lanes |
| `archive/test-runs-core-engine-w038-w045/implementation-conformance/w039-optimized-core-exact-blocker-disposition-001/w039_match_promotion_guard.json` | zero match-promoted rows; W039 declared-gap guard holds |
| `archive/test-runs-core-engine-w038-w045/implementation-conformance/w039-optimized-core-exact-blocker-disposition-001/evidence_summary.json` | source evidence index, W039 obligation bindings, W038 inputs, and W073 formatting-intake guard |
| `archive/test-runs-core-engine-w038-w045/implementation-conformance/w039-optimized-core-exact-blocker-disposition-001/validation.json` | runner validation status `implementation_conformance_w039_exact_blockers_valid` |
...
| JSON parse for `archive/test-runs-core-engine-w038-w045/implementation-conformance/w039-optimized-core-exact-blocker-disposition-001/*.json` | passed |
