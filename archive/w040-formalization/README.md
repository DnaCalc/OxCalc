...
9. `W040_PACK_GRADE_REPLAY_GOVERNANCE_AND_C5_PROMOTION_DECISION.md` - `calc-tv5.9` pack-grade replay governance and C5 promotion decision packet.
10. `W040_CLOSURE_AUDIT_AND_RELEASE_GRADE_VERIFICATION_DECISION.md` - `calc-tv5.10` closure audit and release-grade verification decision packet.

Planned packets:

1. None for W040 after the closure-audit checkpoint.
