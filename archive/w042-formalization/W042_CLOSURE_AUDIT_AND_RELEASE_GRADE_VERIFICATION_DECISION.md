...
The machine-readable audit lives at `archive/test-runs-core-engine-w038-w045/closure-audit/w042-closure-audit-release-grade-verification-decision-001/direct_evidence_coverage_audit.json`.
...
The decision is emitted under `archive/test-runs-core-engine-w038-w045/closure-audit/w042-closure-audit-release-grade-verification-decision-001/`.

## 6. Prompt-To-Artifact Checklist

The machine-readable checklist lives at `archive/test-runs-core-engine-w038-w045/closure-audit/w042-closure-audit-release-grade-verification-decision-001/prompt_to_artifact_checklist.json`.
...
| Command | Result |
|---|---|
| JSON parse for `archive/test-runs-core-engine-w038-w045/closure-audit/w042-closure-audit-release-grade-verification-decision-001/*.json` | passed |
