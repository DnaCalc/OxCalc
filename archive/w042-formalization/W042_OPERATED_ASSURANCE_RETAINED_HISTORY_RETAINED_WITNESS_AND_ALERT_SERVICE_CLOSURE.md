...
| Artifact | Role |
| --- | --- |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/run_summary.json` | W042 summary and no-promotion flags |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/source_evidence_index.json` | 14 source rows binding W042 obligations, W073 intake, W041 service evidence, W042 Stage 2 blockers, and W041 pack decision |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_operated_service_envelope.json` | 9 service-envelope rows |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_retained_history_service_query.json` | 29 retained-history rows, 10 query rows, and 8 replay-correlation rows |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_retained_witness_lifecycle_register.json` | 6 retained-witness lifecycle rows and no pack-eligible witness rows |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_alert_dispatch_service_register.json` | 23 evaluated local alert/quarantine rules |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_cross_engine_service_register.json` | file-backed cross-engine substrate and W042 Stage 2 service dependency disposition |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_service_readiness_register.json` | 21 readiness criteria, 6 blocked |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_exact_service_blocker_register.json` | 6 exact service blockers |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/promotion_decision.json` | explicit no-promotion decision |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/validation.json` | validation counts and zero failures |
...
| JSON parse for `archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/*.json` | passed |
