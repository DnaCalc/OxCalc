...
| Artifact | Role |
| --- | --- |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/run_summary.json` | W043 summary and no-promotion flags |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/source_evidence_index.json` | 15 source rows binding W043 obligations, W073 intake, W042 service evidence, W043 Stage 2 blockers, and W042 pack decision |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_operated_service_envelope.json` | 10 service-envelope rows |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_retained_history_service_query.json` | 33 retained-history rows, 13 query rows, and 11 replay-correlation rows |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_retained_witness_lifecycle_register.json` | 8 retained-witness lifecycle rows and no pack-eligible witness rows |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_alert_dispatch_service_register.json` | 29 evaluated local alert/quarantine rules |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_cross_engine_service_register.json` | file-backed cross-engine substrate and W043 Stage 2 service dependency disposition |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_service_readiness_register.json` | 22 readiness criteria, 6 blocked |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_exact_service_blocker_register.json` | 6 exact service blockers |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/promotion_decision.json` | explicit no-promotion decision |
| `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/validation.json` | validation counts and zero failures |
...
| JSON parse for `archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/*.json` | passed |
