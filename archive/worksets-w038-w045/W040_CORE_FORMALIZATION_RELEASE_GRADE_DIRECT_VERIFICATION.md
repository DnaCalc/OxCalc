...
8. `docs/spec/core-engine/w040-formalization/W040_OXFML_SEAM_BREADTH_AND_CALLABLE_METADATA_IMPLEMENTATION.md` records the `calc-tv5.8` OxFml seam and callable metadata slice. The packet `w040-oxfml-seam-breadth-callable-metadata-001` adds a W040 OxFml seam runner branch and fresh upstream-host artifacts, records 8 source rows, 6 consumed-surface rows, 5 publication/display rows, 6 callable rows, 6 exact blockers, and 0 failed rows. It carries the current OxFml W073 typed-only formatting update, binds public consumer surfaces, `format_delta`/`display_delta`, `LET`/`LAMBDA`, fixture-host and registered-external watch rows, and keeps broad OxFml display/publication, public migration verification, callable metadata projection, callable carrier sufficiency, pack/C5, Stage 2, general OxFunc kernels, and release-grade promotion unpromoted.
9. `docs/spec/core-engine/w040-formalization/W040_PACK_GRADE_REPLAY_GOVERNANCE_AND_C5_PROMOTION_DECISION.md` records the `calc-tv5.9` pack/C5 decision. The packet `w040-pack-grade-replay-governance-c5-promotion-decision-001` adds a W040 pack-capability profile, records 16 satisfied inputs, 32 blockers, 0 missing artifacts, validates 84 required artifacts, and keeps highest honest capability at `cap.C4.distill_valid`. It consumes the W040 direct evidence tranche without promoting `cap.C5.pack_valid`, pack-grade replay, Stage 2 policy, operated services, retained-history service, independent evaluator breadth, broad OxFml display/publication, callable metadata, callable carrier sufficiency, general OxFunc kernels, or release-grade verification.
10. `docs/spec/core-engine/w040-formalization/W040_CLOSURE_AUDIT_AND_RELEASE_GRADE_VERIFICATION_DECISION.md` records the `calc-tv5.10` closure audit and release-grade verification decision. The packet `w040-closure-audit-release-grade-verification-decision-001` audits 9 W040 evidence packets, records direct-evidence coverage across 10 lanes, names 15 residual lane rows, keeps highest honest capability at `cap.C4.distill_valid`, and makes no release-grade, full-formalization, C5, pack-grade replay, Stage 2 policy, operated-service, retained-history, independent-evaluator breadth, broad OxFml, callable metadata, callable carrier, public migration, or general OxFunc promotion.
