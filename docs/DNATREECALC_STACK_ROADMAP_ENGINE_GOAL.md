...
2. Continue W4b candidate-overlay work under bead `calc-4ipg` after the first
   ...
   - richer structural merge algebra beyond the current conservative conflict classification,
