...
2. Continue W4b candidate-overlay work under bead `calc-4ipg` after the first
   ...
   - broader structural order/delete/name-collision merge algebra beyond the first lane-aware and
     same-node rename/move facet merge slices,
