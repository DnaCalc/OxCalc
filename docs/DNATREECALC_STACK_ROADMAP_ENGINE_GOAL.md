...
2. Continue W4b candidate-overlay work under bead `calc-4ipg` after the first
   ...
   - richer structural merge algebra and old-parent/delete-descendant conflict classification,
