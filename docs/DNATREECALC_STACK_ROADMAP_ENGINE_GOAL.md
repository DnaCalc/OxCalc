...
2. Continue W4b candidate-overlay work under bead `calc-4ipg` after the first
   ...
   - richer lease/host-pin candidate retention policy beyond the first budgeted reaper.
