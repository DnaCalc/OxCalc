...
2. Continue W4b candidate-overlay work under bead `calc-4ipg` after the first
   ...
   - optimized merge/rebase conflict policy on the live parent candidate/layer relationship,
