...
| W4a revision graph | Retained parent-linked revision DAG and cursor; undo/redo by revision navigation, never inverse replay | Successor to W057 snapshot-layer model; register currently routes retention through W054 and history substrate as future work | Not implemented as navigable history substrate. Requires spike before undo/history claims. |
