...
2. Continue W4b candidate-overlay work under bead `calc-4ipg` after the first
   ...
   - broader multi-edit structural merge algebra beyond the first lane-aware merge slice,
