...
2. Continue W4b candidate-overlay work under bead `calc-4ipg` after the first
   ...
   - candidate add-node formula/table/template initial content on top of candidate-context dry-bind,
