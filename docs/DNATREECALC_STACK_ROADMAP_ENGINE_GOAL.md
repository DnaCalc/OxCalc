...
2. Continue W4b candidate-overlay work under bead `calc-4ipg` after the first
   ...
   - broader structural order/delete/name-collision merge algebra beyond the first lane-aware,
     same-node rename/move, same-parent rename/add, and same-parent rename/reorder facet merge
     slices,
