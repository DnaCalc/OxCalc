...
2. Continue W4b candidate-overlay work under bead `calc-4ipg` after the first
   ...
   - closed structural candidate mutation intents on top of the candidate-private structural
     projection/read substrate,
