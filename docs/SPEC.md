...
17. Strict Excel grid semantic model: [`CORE_ENGINE_GRID_MODEL.md`](spec/core-engine/CORE_ENGINE_GRID_MODEL.md)
18. Grid refinement and invariant register: [`CORE_ENGINE_GRID_REFINEMENT_AND_EQUIVALENCE.md`](spec/core-engine/CORE_ENGINE_GRID_REFINEMENT_AND_EQUIVALENCE.md)
19. Grid reference machine: [`CORE_ENGINE_GRID_REFERENCE_MACHINE.md`](spec/core-engine/CORE_ENGINE_GRID_REFERENCE_MACHINE.md)
20. Grid performance register: [`CORE_ENGINE_GRID_PERF_REGISTER.md`](spec/core-engine/CORE_ENGINE_GRID_PERF_REGISTER.md)
21. W054 bounded-memory and pinned-epoch retention: [`W054_BOUNDED_MEMORY_AND_PINNED_EPOCH_GC.md`](worksets/W054_BOUNDED_MEMORY_AND_PINNED_EPOCH_GC.md)
22. Transaction-scope spike for DNA TreeCalc W2: [`CORE_ENGINE_TRANSACTION_SCOPE_SPIKE.md`](spec/core-engine/CORE_ENGINE_TRANSACTION_SCOPE_SPIKE.md)
23. Candidate-overlay handle spike for DNA TreeCalc W4b: [`CORE_ENGINE_CANDIDATE_OVERLAY_HANDLE_SPIKE.md`](spec/core-engine/CORE_ENGINE_CANDIDATE_OVERLAY_HANDLE_SPIKE.md)
