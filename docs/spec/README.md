...
- `docs/spec/core-engine/w036-formalization/`
  ...
  - current W036 packet examples: `W036_RESIDUAL_COVERAGE_AND_PROMOTION_BLOCKER_LEDGER.md`, `W036_TRACECALC_COVERAGE_CLOSURE_CRITERIA_AND_MATRIX_EXPANSION.md`, and `W036_OPTIMIZED_CORE_ENGINE_CONFORMANCE_CLOSURE_PLAN_AND_FIRST_FIXES.md`.
