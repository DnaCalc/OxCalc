...
- `docs/spec/core-engine/w048-cycles/`
  ...
  - current packet examples: `W048_CYCLE_LITERATURE_AND_DECISION_MAP.md`, `W048_GRAPH_MATERIALIZATION_AND_CTRO_LAYERS.md`, `W048_EXCEL_PROBE_CATALOG_AND_OBSERVATION_SCHEMA.md`, `W048_EXCEL_OBSERVATION_LEDGER.md`, `W048_ENGINE_AND_FORMALIZATION_ROADMAP.md`, `W048_TEST_CORPUS_AND_CONFORMANCE_PLAN.md`, and `W048_INNOVATION_OPPORTUNITY_LEDGER.md`.
