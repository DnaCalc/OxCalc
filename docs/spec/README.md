...
For the repo-level spec/design entrypoint, start at [`../SPEC.md`](../SPEC.md). This file remains the detailed index for the OxCalc-owned mutable spec library.
...
1. start with `README.md`, `CHARTER.md`, `OPERATIONS.md`, `docs/SPEC.md`, `docs/WORKSET_REGISTER.md`, and `docs/IN_PROGRESS_FEATURE_WORKLIST.md`; use `docs/BEADS.md` only when bead mechanics are directly relevant,
...
- `docs/spec/core-engine/w047-ctro/`
  - active W047 packet root for Calc-Time Rebinding Overlay design and implementation-support packets, starting with the historical no-loss CTRO crosswalk for `calc-aylq.1`.
  - current packet examples: `W047_HISTORICAL_NO_LOSS_CTRO_CROSSWALK.md`, `W047_EFFECTIVE_GRAPH_OVERLAY_AND_FRONTIER_REPAIR_SEMANTICS.md`, `W047_CTRO_SCENARIO_MATRIX_AND_TRACE_FACTS.md`, `W047_IMPLEMENTATION_ROADMAP_AND_SUCCESSOR_GATES.md`, and `W047_DYNAMIC_DEPENDENCY_POSITIVE_PUBLICATION_EVIDENCE.md`.
- `docs/spec/core-engine/w048-cycles/`
  - active W048 packet root for circular dependency calculation processing: Excel evidence and probes, graph materialization across structural/published-effective/candidate-effective layers, cycle-root/order and iterative-profile decision axes, structural and CTRO-created cycle policy, release/re-entry, TraceCalc reference behavior, TreeCalc optimized/core behavior, W048 formal definitions/models/checker targets, circular-reference test corpus, and profile-gated innovation opportunities.
  - current packet examples: `W048_REOPEN_SCOPE_AUDIT_AND_REPAIR_PLAN.md`, `W048_TOOLING_MIGRATION_OFF_PYTHON.md`, `W048_WHOLE_WORKSET_FRESH_EYES_AUDIT.md`, `W048_SINGLE_HOST_SCOPE_ACCEPTANCE_AND_FINAL_AUDIT.md`, `W048_EXCEL_ROOT_REPORT_BLOCKER_PACKET.md`, `W048_EXCEL_INITIAL_VECTOR_PACKET.md`, `W048_EXCEL_NONNUMERIC_PRIOR_PACKET.md`, `W048_EXCEL_VERSION_REPEAT_BLOCKER_PACKET.md`, `W048_EXCEL_MULTITHREAD_VARIANT_PACKET.md`, `W048_EXTERNAL_EXCEL_UNBLOCK_KIT.md`, `W048_CYCLE_LITERATURE_AND_DECISION_MAP.md`, `W048_GRAPH_MATERIALIZATION_AND_CTRO_LAYERS.md`, `W048_MATERIALIZED_GRAPH_SIDECAR_EVIDENCE.md`, `W048_EXCEL_PROBE_CATALOG_AND_OBSERVATION_SCHEMA.md`, `W048_EXCEL_OBSERVATION_LEDGER.md`, `W048_TRACECALC_REFERENCE_CYCLE_BEHAVIOR.md`, `W048_TREECALC_OPTIMIZED_CYCLE_BEHAVIOR.md`, `W048_CORPUS_AND_CONFORMANCE_EVIDENCE.md`, `W048_FORMAL_CYCLE_DEFINITIONS_AND_CHECKER_ARTIFACTS.md`, `W048_ITERATIVE_PROFILE_DECISION_AND_EXCEL_DISPOSITION.md`, `W048_CLOSURE_AUDIT_AND_SUCCESSOR_ROUTING.md`, `W048_ENGINE_AND_FORMALIZATION_ROADMAP.md`, `W048_TEST_CORPUS_AND_CONFORMANCE_PLAN.md`, and `W048_INNOVATION_OPPORTUNITY_LEDGER.md`.
- `docs/spec/core-engine/w055-cycles/`
  - active W055 packet root for turning the W048 single-host circular-reference fixture floor into a product-grade cycle and iterative-calculation feature area. It currently owns Tranche A rollout scope and DnaTreeCalc cycle-config handover intake.
