...
8. `replay-appliance/validation/pack_grade_decision.json` for the explicit capability and handoff decision over the current evaluated scope,
9. `replay-appliance/validation/program_grade_contract.json` for the broader program-scope pack contract beyond the current semantic-only family,
10. `replay-appliance/validation/program_grade_validation.json` for the explicit broader program-scope blocker state,
11. `replay-appliance/validation/program_grade_decision.json` for the explicit broader program-scope capability and handoff decision,
11. `replay-appliance/runs/<run_id>/cases/<case_id>/distill_validation.json` and `pack_candidate_assessment.json` for retained-failure case projections.
