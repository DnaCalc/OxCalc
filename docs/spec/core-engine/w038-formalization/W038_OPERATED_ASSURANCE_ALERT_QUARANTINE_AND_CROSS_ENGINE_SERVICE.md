...
| `docs/test-runs/core-engine/tracecalc-authority/w038-tracecalc-authority-discharge-001/run_summary.json` | W038 TraceCalc authority source row |
| `docs/test-runs/core-engine/implementation-conformance/w038-optimized-core-conformance-disposition-001/run_summary.json` | W038 optimized/core conformance source row |
| `docs/test-runs/core-engine/formal-assurance/w038-proof-model-assumption-discharge-001/run_summary.json` | W038 proof/model source row |
| `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/` | W038 bounded Stage 2 replay source row and no-promotion decision |
...
| `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/run_summary.json` | 8 source rows, 15 history rows, 8 alert rules, 4 exact blockers, 0 failed rows |
| `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/multi_run_history.json` | W037 history extended with W038 authority, conformance, proof/model, and Stage 2 rows |
| `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/alert_quarantine_enforcement.json` | local deterministic evaluation of 8 alert/quarantine rules; 0 quarantine decisions |
| `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/cross_engine_service_disposition.json` | file-backed cross-engine pilot bound without service promotion |
| `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/service_readiness_disposition.json` | 10 readiness criteria, 4 blocked service criteria |
| `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/exact_service_blocker_register.json` | 4 exact service blockers |
| `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/promotion_decision.json` | operated service, cross-engine service, alert dispatcher, pack/C5, and Stage 2 remain unpromoted |
| `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/source_evidence_index.json` | source artifact index |
| `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/validation.json` | validation status `w038_operated_assurance_packet_valid` |
...
| JSON parse for `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/*.json` | passed |
