...
| `docs/test-runs/core-engine/tracecalc-authority/w038-tracecalc-authority-discharge-001/` | W038 TraceCalc authority input |
| `docs/test-runs/core-engine/implementation-conformance/w038-optimized-core-conformance-disposition-001/` | W038 optimized/core conformance input |
| `docs/test-runs/core-engine/formal-assurance/w038-proof-model-assumption-discharge-001/` | W038 proof/model and totality-boundary input |
| `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/` | W038 bounded Stage 2 replay and no-promotion input |
| `docs/test-runs/core-engine/operated-assurance/w038-operated-assurance-alert-quarantine-001/` | W038 operated-assurance and service-disposition input |
| `docs/test-runs/core-engine/diversity-seam/w038-diversity-seam-watch-001/` | W038 independent-diversity and OxFml seam-watch input |
...
| `docs/test-runs/core-engine/pack-capability/w038-pack-c5-release-decision-001/run_summary.json` | 13 satisfied inputs, 25 blockers, 0 missing artifacts, highest honest capability `cap.C4.distill_valid` |
| `docs/test-runs/core-engine/pack-capability/w038-pack-c5-release-decision-001/evidence/evidence_index.json` | evidence index across retained pack inputs, W037 carried direct evidence, and W038 direct packets |
| `docs/test-runs/core-engine/pack-capability/w038-pack-c5-release-decision-001/decision/pack_capability_decision.json` | C5 and Stage 2 remain unpromoted |
| `docs/test-runs/core-engine/pack-capability/w038-pack-c5-release-decision-001/replay-appliance/bundle_manifest.json` | replay-appliance decision bundle manifest |
| `docs/test-runs/core-engine/pack-capability/w038-pack-c5-release-decision-001/replay-appliance/validation/bundle_validation.json` | bundle validation status `bundle_valid` |
...
| JSON parse for `docs/test-runs/core-engine/pack-capability/w038-pack-c5-release-decision-001/**/*.json` | passed; 5 JSON files parsed |
