...
| `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/run_summary.json` | 5 partition replay rows, 6 permutation rows, 5 invariant rows, 1 formatting watch row, 3 exact blockers, 0 failed rows |
| `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/partition_replay_matrix.json` | baseline-versus-Stage-2 replay projection matrix |
| `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/partition_order_permutation_replay.json` | admissible partition-order permutation rows |
| `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/semantic_equivalence_report.json` | bounded semantic-equivalence statement and W037 replay-blocker disposition |
| `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/stage2_exact_blocker_register.json` | 3 remaining exact Stage 2 blockers |
| `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/promotion_decision.json` | Stage 2 policy remains unpromoted |
| `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/source_evidence_index.json` | source artifact index including W073 formatting guard |
| `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/validation.json` | validation status `w038_stage2_replay_valid` |
...
| JSON parse for `docs/test-runs/core-engine/stage2-replay/w038-stage2-partition-replay-001/*.json` | passed |
