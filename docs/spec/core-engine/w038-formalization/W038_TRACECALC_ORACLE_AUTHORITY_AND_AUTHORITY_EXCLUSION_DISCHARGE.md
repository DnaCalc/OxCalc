...
| Artifact | Result |
|---|---|
| `docs/test-runs/core-engine/tracecalc-authority/w038-tracecalc-authority-discharge-001/run_summary.json` | records scoped TraceCalc authority disposition |
| `docs/test-runs/core-engine/tracecalc-authority/w038-tracecalc-authority-discharge-001/authority_discharge_ledger.json` | discharges the general OxFunc kernel exclusion as external authority |
| `docs/test-runs/core-engine/tracecalc-authority/w038-tracecalc-authority-discharge-001/oracle_authority_map.json` | maps covered, excluded, superseded, and non-TraceCalc gates |
| `docs/test-runs/core-engine/tracecalc-authority/w038-tracecalc-authority-discharge-001/validation.json` | records validation for this packet |
...
| Command | Result |
|---|---|
| JSON parse for `docs/test-runs/core-engine/tracecalc-authority/w038-tracecalc-authority-discharge-001/*.json` | passed |
