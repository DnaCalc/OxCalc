...
| Artifact | Purpose |
| --- | --- |
| `docs/test-runs/core-engine/implementation-conformance/w041-optimized-core-residual-blocker-differentials-001/run_summary.json` | records W041.2 counts, remaining blockers, no-promotion claims, and next bead |
| `docs/test-runs/core-engine/implementation-conformance/w041-optimized-core-residual-blocker-differentials-001/dynamic_release_reclassification_auto_transition_evidence.json` | binds the automatic dynamic transition fixture to predecessor/successor descriptor evidence |
| `docs/test-runs/core-engine/implementation-conformance/w041-optimized-core-residual-blocker-differentials-001/w041_exact_blocker_disposition_register.json` | records disposition rows for W040 optimized/core exact blockers |
| `docs/test-runs/core-engine/implementation-conformance/w041-optimized-core-residual-blocker-differentials-001/w041_exact_remaining_blocker_register.json` | retains three exact blockers for later W041 lanes |
| `docs/test-runs/core-engine/implementation-conformance/w041-optimized-core-residual-blocker-differentials-001/w041_match_promotion_guard.json` | records zero match promotion |
| `docs/test-runs/core-engine/implementation-conformance/w041-optimized-core-residual-blocker-differentials-001/source_evidence_index.json` | indexes predecessor, code, replay, and OxFml formatting intake sources |
| `docs/test-runs/core-engine/implementation-conformance/w041-optimized-core-residual-blocker-differentials-001/validation.json` | records validation commands and artifact checks |

The direct replay evidence is:

1. `docs/test-runs/core-engine/treecalc-local/w041-optimized-core-automatic-dynamic-transition-001/run_summary.json`
2. `docs/test-runs/core-engine/treecalc-local/w041-optimized-core-automatic-dynamic-transition-001/cases/tc_local_dynamic_release_reclassification_auto_post_edit_001/post_edit/invalidation_seeds.json`
3. `docs/test-runs/core-engine/treecalc-local/w041-optimized-core-automatic-dynamic-transition-001/cases/tc_local_dynamic_release_reclassification_auto_post_edit_001/post_edit/invalidation_closure.json`
4. `docs/test-runs/core-engine/treecalc-local/w041-optimized-core-automatic-dynamic-transition-001/cases/tc_local_dynamic_release_reclassification_auto_post_edit_001/post_edit/result.json`
