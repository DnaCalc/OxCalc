...
| Path | Change |
|---|---|
| `docs/test-runs/core-engine/treecalc-local/w042-optimized-core-counterpart-conformance-treecalc-001/` | fresh W042 TreeCalc replay over the current local corpus |
| `docs/test-runs/core-engine/implementation-conformance/w042-optimized-core-counterpart-conformance-callable-metadata-001/` | W042 implementation-conformance packet |
...
| Artifact | Purpose |
|---|---|
| `docs/test-runs/core-engine/implementation-conformance/w042-optimized-core-counterpart-conformance-callable-metadata-001/run_summary.json` | records W042.2 counts, remaining blockers, no-promotion claims, and next bead |
| `docs/test-runs/core-engine/implementation-conformance/w042-optimized-core-counterpart-conformance-callable-metadata-001/w042_counterpart_conformance_register.json` | records dynamic, snapshot, capability, callable, no-proxy, and full-conformance disposition rows |
| `docs/test-runs/core-engine/implementation-conformance/w042-optimized-core-counterpart-conformance-callable-metadata-001/w042_callable_metadata_projection_register.json` | separates callable value/carrier evidence from callable metadata projection |
| `docs/test-runs/core-engine/implementation-conformance/w042-optimized-core-counterpart-conformance-callable-metadata-001/w042_exact_remaining_blocker_register.json` | retains three exact W042 optimized/core blockers |
| `docs/test-runs/core-engine/implementation-conformance/w042-optimized-core-counterpart-conformance-callable-metadata-001/w042_match_promotion_guard.json` | records zero match promotion |
| `docs/test-runs/core-engine/implementation-conformance/w042-optimized-core-counterpart-conformance-callable-metadata-001/w073_formatting_intake.json` | records the current OxFml W073 typed-only formatting working-tree intake |
| `docs/test-runs/core-engine/implementation-conformance/w042-optimized-core-counterpart-conformance-callable-metadata-001/source_evidence_index.json` | indexes W042 TreeCalc, W041 Stage 2, W041 OxFml seam, W041 upstream-host, W042 ledger, and current OxFml W073 working-tree sources |
| `docs/test-runs/core-engine/implementation-conformance/w042-optimized-core-counterpart-conformance-callable-metadata-001/validation.json` | records validation commands and artifact checks |

The direct replay evidence is:

1. `docs/test-runs/core-engine/treecalc-local/w042-optimized-core-counterpart-conformance-treecalc-001/run_summary.json`,
2. `docs/test-runs/core-engine/treecalc-local/w042-optimized-core-counterpart-conformance-treecalc-001/cases/tc_local_dynamic_release_reclassification_auto_post_edit_001/post_edit/invalidation_seeds.json`,
3. `docs/test-runs/core-engine/treecalc-local/w042-optimized-core-counterpart-conformance-treecalc-001/cases/tc_local_dynamic_release_reclassification_auto_post_edit_001/post_edit/invalidation_closure.json`,
4. `docs/test-runs/core-engine/treecalc-local/w042-optimized-core-counterpart-conformance-treecalc-001/cases/tc_local_capability_sensitive_reject_001/result.json`,
5. `docs/test-runs/core-engine/treecalc-local/w042-optimized-core-counterpart-conformance-treecalc-001/cases/tc_local_w034_higher_order_let_lambda_publish_001/result.json`.
...
| JSON parse for `docs/test-runs/core-engine/implementation-conformance/w042-optimized-core-counterpart-conformance-callable-metadata-001/*.json` | passed |
