...
1. `W043_PACK_GRADE_REPLAY_GOVERNANCE_AND_C5_RELEASE_REASSESSMENT.md` - `calc-2p3.9` pack-grade replay governance and C5 release reassessment.
2. `W043_CLOSURE_AUDIT_AND_RELEASE_GRADE_VERIFICATION_DECISION.md` - `calc-2p3.10` closure audit and release-grade verification decision.
