...
The machine-readable audit lives at `docs/test-runs/core-engine/closure-audit/w043-closure-audit-release-grade-verification-decision-001/direct_evidence_coverage_audit.json`.
...
The decision is emitted under `docs/test-runs/core-engine/closure-audit/w043-closure-audit-release-grade-verification-decision-001/`.

## 6. Prompt-To-Artifact Checklist

The machine-readable checklist lives at `docs/test-runs/core-engine/closure-audit/w043-closure-audit-release-grade-verification-decision-001/prompt_to_artifact_checklist.json`.
...
| JSON parse for `docs/test-runs/core-engine/closure-audit/w043-closure-audit-release-grade-verification-decision-001/*.json` | passed |
