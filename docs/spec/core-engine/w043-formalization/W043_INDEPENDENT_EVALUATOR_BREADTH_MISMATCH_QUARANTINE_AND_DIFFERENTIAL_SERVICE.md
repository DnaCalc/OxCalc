...
| Artifact | Purpose |
|---|---|
| `docs/test-runs/core-engine/diversity-seam/w043-independent-evaluator-breadth-mismatch-quarantine-differential-service-001/run_summary.json` | records row counts, no-promotion flags, service blockers, and W073 guard retention |
| `docs/test-runs/core-engine/diversity-seam/w043-independent-evaluator-breadth-mismatch-quarantine-differential-service-001/source_evidence_index.json` | 17 source rows binding W043 obligations, W073 intake, W042 diversity evidence, W043 Stage 2 evidence, and W043 operated-assurance evidence |
| `docs/test-runs/core-engine/diversity-seam/w043-independent-evaluator-breadth-mismatch-quarantine-differential-service-001/w043_independent_reference_model_implementation.json` | 6 independent reference-model cases and 6 matches |
| `docs/test-runs/core-engine/diversity-seam/w043-independent-evaluator-breadth-mismatch-quarantine-differential-service-001/w043_independent_evaluator_breadth_register.json` | 13 independent-evaluator breadth rows |
| `docs/test-runs/core-engine/diversity-seam/w043-independent-evaluator-breadth-mismatch-quarantine-differential-service-001/w043_cross_engine_differential_service_register.json` | 12 cross-engine differential and service-classification rows |
| `docs/test-runs/core-engine/diversity-seam/w043-independent-evaluator-breadth-mismatch-quarantine-differential-service-001/w043_mismatch_quarantine_authority_router.json` | 12 mismatch-authority rows |
| `docs/test-runs/core-engine/diversity-seam/w043-independent-evaluator-breadth-mismatch-quarantine-differential-service-001/w043_exact_diversity_blocker_register.json` | 8 exact diversity, operated-service, mismatch, and release-grade blockers |
| `docs/test-runs/core-engine/diversity-seam/w043-independent-evaluator-breadth-mismatch-quarantine-differential-service-001/promotion_decision.json` | explicit no-promotion decision and semantic-equivalence statement |
| `docs/test-runs/core-engine/diversity-seam/w043-independent-evaluator-breadth-mismatch-quarantine-differential-service-001/validation.json` | validation counts and zero failures |
...
| JSON parse for `docs/test-runs/core-engine/diversity-seam/w043-independent-evaluator-breadth-mismatch-quarantine-differential-service-001/*.json` | passed |
