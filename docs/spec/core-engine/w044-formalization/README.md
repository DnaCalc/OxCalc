...
1. `W044_LEAN_TLA_UNBOUNDED_FAIRNESS_AND_FULL_VERIFICATION_PROOF_EXPANSION.md` - `calc-b1t.4` Lean/TLA proof/model tranche.
2. `W044_STAGE2_PRODUCTION_PARTITION_ANALYZER_AND_SCHEDULER_EQUIVALENCE_IMPLEMENTATION.md` - `calc-b1t.5` Stage 2 tranche.
3. `W044_OPERATED_CONTINUOUS_ASSURANCE_RETAINED_HISTORY_WITNESS_SLO_AND_ALERT_SERVICE.md` - `calc-b1t.6` operated service tranche.
4. `W044_INDEPENDENT_EVALUATOR_BREADTH_MISMATCH_QUARANTINE_AND_DIFFERENTIAL_SERVICE_IMPLEMENTATION.md` - `calc-b1t.7` diversity/service tranche.
5. `W044_OXFML_PUBLIC_MIGRATION_TYPED_FORMATTING_CALLABLE_AND_REGISTERED_EXTERNAL_UPTAKE.md` - `calc-b1t.8` OxFml seam tranche.
6. `W044_RELEASE_SCALE_REPLAY_PERFORMANCE_AND_SCALING_EVIDENCE_UNDER_SEMANTIC_GUARDS.md` - `calc-b1t.9` release-scale replay/performance tranche.
7. `W044_PACK_GRADE_REPLAY_GOVERNANCE_SERVICE_AND_C5_REASSESSMENT.md` - `calc-b1t.10` pack/C5 tranche.
8. `W044_CLOSURE_AUDIT_AND_RELEASE_GRADE_VERIFICATION_DECISION.md` - `calc-b1t.11` closure audit and release-grade decision.
