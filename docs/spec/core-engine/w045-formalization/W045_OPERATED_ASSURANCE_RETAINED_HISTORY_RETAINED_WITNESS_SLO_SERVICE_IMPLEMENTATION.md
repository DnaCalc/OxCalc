...
| Artifact | Role |
|---|---|
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/source_evidence_index.json` | W045 source rows over W045.1-W045.5, W044 operated assurance, W044 pack/C5, and W073 intake |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/w045_operated_service_envelope.json` | service envelope with local-harness boundary |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/w045_operated_service_harness_register.json` | 8-operation local runnable harness register |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/w045_retained_history_service_query.json` | retained-history store/query/replay-correlation extension |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/w045_retained_witness_lifecycle_register.json` | retained-witness lifecycle extension without pack eligibility |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/w045_alert_dispatch_service_register.json` | local alert/quarantine rule evaluation |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/w045_cross_engine_service_register.json` | cross-engine service blocker classification |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/w045_service_readiness_register.json` | 31 readiness criteria with 6 exact service blockers |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/w045_exact_service_blocker_register.json` | exact service blocker register |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/promotion_decision.json` | no-promotion decision and semantic-equivalence statement |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/validation.json` | deterministic validation summary |
| `docs/test-runs/core-engine/operated-assurance/w045-operated-assurance-retained-history-retained-witness-slo-service-001/run_summary.json` | top-level run summary |
