...
- open_lanes:
  - W018 is newly sequenced and no bundle-emission realization has started yet
  - `cap.C2.diff_valid` and `cap.C3.explain_valid` remain unproven by emitted bundle evidence
  - no replay-appliance-aware checked-in baseline exists yet
