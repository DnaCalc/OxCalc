...
pub const W056_NON_TABLE_REFERENCE_CATEGORIES: &[W056NonTableReferenceCategory] = &[
    ...
    W056NonTableReferenceCategory {
        ...
        oxcalc_status: "current defined-name-LAMBDA mapping admitted by calc-4vs8.32; direct OxCalcTreeContext now calls lambda-valued host nodes as callable candidates (consumer.rs treecalc_context_can_call_lambda_value_published_by_another_node), not typed pending/exclusion",
        dnatreecalc_status: "active direct OxCalcTreeContext callable slice for single-reference lambda-valued nodes; broader node-functions corpus pending",
        replay_status: "retained non-table replay missing",
