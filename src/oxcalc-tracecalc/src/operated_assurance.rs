...
//! W038/W039/W040/W041/W042/W043/W044/W045 operated-assurance, alert/quarantine, and service-disposition packet emission.
...
const W044_RUN_SUMMARY_SCHEMA_V1: &str = "oxcalc.operated_assurance.w044.run_summary.v1";
const W044_SOURCE_INDEX_SCHEMA_V1: &str = "oxcalc.operated_assurance.w044.source_evidence_index.v1";
const W044_SERVICE_ENVELOPE_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w044.operated_service_envelope.v1";
const W044_RETAINED_HISTORY_SERVICE_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w044.retained_history_service_query.v1";
const W044_RETAINED_WITNESS_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w044.retained_witness_lifecycle.v1";
const W044_ALERT_DISPATCH_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w044.alert_dispatch_service_register.v1";
const W044_CROSS_ENGINE_SERVICE_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w044.cross_engine_service_register.v1";
const W044_SERVICE_READINESS_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w044.service_readiness_register.v1";
const W044_BLOCKER_REGISTER_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w044.exact_service_blocker_register.v1";
const W044_PROMOTION_DECISION_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w044.promotion_decision.v1";
const W044_VALIDATION_SCHEMA_V1: &str = "oxcalc.operated_assurance.w044.validation.v1";
const W045_RUN_SUMMARY_SCHEMA_V1: &str = "oxcalc.operated_assurance.w045.run_summary.v1";
const W045_SOURCE_INDEX_SCHEMA_V1: &str = "oxcalc.operated_assurance.w045.source_evidence_index.v1";
const W045_SERVICE_ENVELOPE_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w045.operated_service_envelope.v1";
const W045_SERVICE_HARNESS_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w045.operated_service_harness.v1";
const W045_RETAINED_HISTORY_SERVICE_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w045.retained_history_service_query.v1";
const W045_RETAINED_WITNESS_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w045.retained_witness_lifecycle.v1";
const W045_ALERT_DISPATCH_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w045.alert_dispatch_service_register.v1";
const W045_CROSS_ENGINE_SERVICE_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w045.cross_engine_service_register.v1";
const W045_SERVICE_READINESS_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w045.service_readiness_register.v1";
const W045_BLOCKER_REGISTER_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w045.exact_service_blocker_register.v1";
const W045_PROMOTION_DECISION_SCHEMA_V1: &str =
    "oxcalc.operated_assurance.w045.promotion_decision.v1";
const W045_VALIDATION_SCHEMA_V1: &str = "oxcalc.operated_assurance.w045.validation.v1";
...
const W038_TRACECALC_AUTHORITY_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/tracecalc-authority/w038-tracecalc-authority-discharge-001/run_summary.json";
const W038_IMPLEMENTATION_CONFORMANCE_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/implementation-conformance/w038-optimized-core-conformance-disposition-001/run_summary.json";
const W038_FORMAL_ASSURANCE_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/formal-assurance/w038-proof-model-assumption-discharge-001/run_summary.json";
const W038_STAGE2_REPLAY_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w038-stage2-partition-replay-001/run_summary.json";
const W038_STAGE2_REPLAY_DECISION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w038-stage2-partition-replay-001/promotion_decision.json";
...
const W038_OPERATED_ASSURANCE_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w038-operated-assurance-alert-quarantine-001/run_summary.json";
const W038_OPERATED_ASSURANCE_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w038-operated-assurance-alert-quarantine-001/validation.json";
const W038_OPERATED_MULTI_RUN_HISTORY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w038-operated-assurance-alert-quarantine-001/multi_run_history.json";
const W038_OPERATED_ALERT_QUARANTINE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w038-operated-assurance-alert-quarantine-001/alert_quarantine_enforcement.json";
const W038_OPERATED_CROSS_ENGINE_SERVICE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w038-operated-assurance-alert-quarantine-001/cross_engine_service_disposition.json";
const W038_OPERATED_SERVICE_READINESS: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w038-operated-assurance-alert-quarantine-001/service_readiness_disposition.json";
const W038_OPERATED_SERVICE_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w038-operated-assurance-alert-quarantine-001/exact_service_blocker_register.json";
const W038_OPERATED_PROMOTION_DECISION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w038-operated-assurance-alert-quarantine-001/promotion_decision.json";
const W039_STAGE2_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w039-stage2-production-policy-replay-governance-001/run_summary.json";
...
const W039_STAGE2_DECISION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w039-stage2-production-policy-replay-governance-001/promotion_decision.json";
...
const W038_PACK_DECISION: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w038-pack-c5-release-decision-001/decision/pack_capability_decision.json";
...
const W039_OPERATED_ASSURANCE_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w039-operated-assurance-retained-history-001/run_summary.json";
const W039_OPERATED_ASSURANCE_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w039-operated-assurance-retained-history-001/validation.json";
const W039_RETAINED_HISTORY_LIFECYCLE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w039-operated-assurance-retained-history-001/w039_retained_history_lifecycle.json";
const W039_ALERT_DISPATCHER_ENFORCEMENT: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w039-operated-assurance-retained-history-001/w039_alert_dispatcher_enforcement.json";
const W039_CROSS_ENGINE_SERVICE_SUBSTRATE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w039-operated-assurance-retained-history-001/w039_cross_engine_service_substrate.json";
const W039_SERVICE_READINESS_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w039-operated-assurance-retained-history-001/w039_service_readiness_register.json";
const W039_OPERATED_SERVICE_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w039-operated-assurance-retained-history-001/w039_exact_service_blocker_register.json";
const W039_OPERATED_PROMOTION_DECISION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w039-operated-assurance-retained-history-001/promotion_decision.json";
const W040_STAGE2_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w040-stage2-production-policy-equivalence-001/run_summary.json";
...
const W040_STAGE2_DECISION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w040-stage2-production-policy-equivalence-001/promotion_decision.json";
...
const W040_OPERATED_ASSURANCE_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w040-operated-assurance-retained-history-service-001/run_summary.json";
const W040_OPERATED_ASSURANCE_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w040-operated-assurance-retained-history-service-001/validation.json";
const W040_OPERATED_RUNNER_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w040-operated-assurance-retained-history-service-001/w040_operated_runner_register.json";
const W040_RETAINED_HISTORY_STORE_QUERY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w040-operated-assurance-retained-history-service-001/w040_retained_history_store_query.json";
const W040_ALERT_DISPATCHER_ENFORCEMENT: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w040-operated-assurance-retained-history-service-001/w040_alert_dispatcher_enforcement.json";
const W040_CROSS_ENGINE_SERVICE_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w040-operated-assurance-retained-history-service-001/w040_cross_engine_service_register.json";
const W040_SERVICE_READINESS_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w040-operated-assurance-retained-history-service-001/w040_service_readiness_register.json";
const W040_OPERATED_SERVICE_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w040-operated-assurance-retained-history-service-001/w040_exact_service_blocker_register.json";
const W040_OPERATED_PROMOTION_DECISION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w040-operated-assurance-retained-history-service-001/promotion_decision.json";
...
const W041_STAGE2_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w041-stage2-production-analyzer-pack-equivalence-001/run_summary.json";
const W041_STAGE2_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w041-stage2-production-analyzer-pack-equivalence-001/validation.json";
const W041_STAGE2_DECISION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w041-stage2-production-analyzer-pack-equivalence-001/promotion_decision.json";
const W041_STAGE2_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w041-stage2-production-analyzer-pack-equivalence-001/w041_stage2_exact_blocker_register.json";
const W041_OPERATED_ASSURANCE_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w041-operated-assurance-retained-history-alert-dispatch-001/run_summary.json";
const W041_OPERATED_ASSURANCE_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w041-operated-assurance-retained-history-alert-dispatch-001/validation.json";
const W041_OPERATED_SERVICE_ENVELOPE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w041-operated-assurance-retained-history-alert-dispatch-001/w041_operated_service_envelope.json";
const W041_RETAINED_HISTORY_SERVICE_QUERY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w041-operated-assurance-retained-history-alert-dispatch-001/w041_retained_history_service_query.json";
const W041_RETAINED_WITNESS_LIFECYCLE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w041-operated-assurance-retained-history-alert-dispatch-001/w041_retained_witness_lifecycle_register.json";
const W041_ALERT_DISPATCH_SERVICE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w041-operated-assurance-retained-history-alert-dispatch-001/w041_alert_dispatch_service_register.json";
const W041_CROSS_ENGINE_SERVICE_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w041-operated-assurance-retained-history-alert-dispatch-001/w041_cross_engine_service_register.json";
const W041_SERVICE_READINESS_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w041-operated-assurance-retained-history-alert-dispatch-001/w041_service_readiness_register.json";
const W041_OPERATED_SERVICE_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w041-operated-assurance-retained-history-alert-dispatch-001/w041_exact_service_blocker_register.json";
const W041_OPERATED_PROMOTION_DECISION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w041-operated-assurance-retained-history-alert-dispatch-001/promotion_decision.json";
const W041_PACK_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w041-pack-grade-replay-governance-c5-reassessment-001/run_summary.json";
const W041_PACK_DECISION: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w041-pack-grade-replay-governance-c5-reassessment-001/decision/pack_capability_decision.json";
...
const W042_STAGE2_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w042-stage2-production-analyzer-pack-grade-equivalence-closure-001/run_summary.json";
const W042_STAGE2_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w042-stage2-production-analyzer-pack-grade-equivalence-closure-001/validation.json";
const W042_STAGE2_DECISION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w042-stage2-production-analyzer-pack-grade-equivalence-closure-001/promotion_decision.json";
const W042_STAGE2_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w042-stage2-production-analyzer-pack-grade-equivalence-closure-001/w042_stage2_exact_blocker_register.json";
const W042_OPERATED_ASSURANCE_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/run_summary.json";
const W042_OPERATED_ASSURANCE_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/validation.json";
const W042_OPERATED_SERVICE_ENVELOPE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_operated_service_envelope.json";
const W042_RETAINED_HISTORY_SERVICE_QUERY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_retained_history_service_query.json";
const W042_RETAINED_WITNESS_LIFECYCLE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_retained_witness_lifecycle_register.json";
const W042_ALERT_DISPATCH_SERVICE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_alert_dispatch_service_register.json";
const W042_CROSS_ENGINE_SERVICE_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_cross_engine_service_register.json";
const W042_SERVICE_READINESS_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_service_readiness_register.json";
const W042_OPERATED_SERVICE_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/w042_exact_service_blocker_register.json";
const W042_OPERATED_PROMOTION_DECISION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w042-operated-assurance-retained-history-retained-witness-alert-service-001/promotion_decision.json";
...
const W043_STAGE2_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w043-stage2-production-partition-analyzer-scheduler-equivalence-001/run_summary.json";
const W043_STAGE2_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w043-stage2-production-partition-analyzer-scheduler-equivalence-001/validation.json";
const W043_STAGE2_DECISION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w043-stage2-production-partition-analyzer-scheduler-equivalence-001/promotion_decision.json";
const W043_STAGE2_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w043-stage2-production-partition-analyzer-scheduler-equivalence-001/w043_stage2_exact_blocker_register.json";
const W043_OPERATED_ASSURANCE_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/run_summary.json";
const W043_OPERATED_ASSURANCE_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/validation.json";
const W043_OPERATED_SERVICE_ENVELOPE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_operated_service_envelope.json";
const W043_RETAINED_HISTORY_SERVICE_QUERY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_retained_history_service_query.json";
const W043_RETAINED_WITNESS_LIFECYCLE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_retained_witness_lifecycle_register.json";
const W043_ALERT_DISPATCH_SERVICE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_alert_dispatch_service_register.json";
const W043_CROSS_ENGINE_SERVICE_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_cross_engine_service_register.json";
const W043_SERVICE_READINESS_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_service_readiness_register.json";
const W043_OPERATED_SERVICE_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/w043_exact_service_blocker_register.json";
const W043_OPERATED_PROMOTION_DECISION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w043-operated-assurance-retained-history-witness-slo-alert-service-001/promotion_decision.json";
...
const W044_RESIDUAL_MAP: &str = "archive/test-runs-core-engine-w038-w045/release-grade-ledger/w044-residual-release-grade-blocker-reclassification-map-001/blocker_reclassification_map.json";
...
const W044_OPTIMIZED_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/implementation-conformance/w044-optimized-core-dynamic-transition-callable-metadata-001/run_summary.json";
const W044_OPTIMIZED_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/implementation-conformance/w044-optimized-core-dynamic-transition-callable-metadata-001/validation.json";
const W044_DYNAMIC_TRANSITION_EVIDENCE: &str = "archive/test-runs-core-engine-w038-w045/implementation-conformance/w044-optimized-core-dynamic-transition-callable-metadata-001/w044_dynamic_transition_evidence.json";
const W044_OPTIMIZED_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/implementation-conformance/w044-optimized-core-dynamic-transition-callable-metadata-001/w044_exact_remaining_blocker_register.json";
...
const W044_RUST_REFINEMENT: &str = "archive/test-runs-core-engine-w038-w045/formal-assurance/w044-rust-totality-refinement-panic-surface-expansion-001/w044_rust_refinement_register.json";
const W044_RUST_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/formal-assurance/w044-rust-totality-refinement-panic-surface-expansion-001/w044_rust_exact_blocker_register.json";
...
const W044_TLA_MODEL_BOUND: &str = "archive/test-runs-core-engine-w038-w045/formal-assurance/w044-lean-tla-unbounded-fairness-full-verification-expansion-001/w044_tla_model_bound_register.json";
...
const W044_STAGE2_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w044-stage2-production-partition-analyzer-scheduler-equivalence-001/run_summary.json";
const W044_STAGE2_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w044-stage2-production-partition-analyzer-scheduler-equivalence-001/validation.json";
const W044_STAGE2_DECISION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w044-stage2-production-partition-analyzer-scheduler-equivalence-001/promotion_decision.json";
const W044_STAGE2_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w044-stage2-production-partition-analyzer-scheduler-equivalence-001/w044_stage2_exact_blocker_register.json";
const W044_OPERATED_ASSURANCE_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w044-operated-assurance-retained-history-witness-slo-alert-service-001/run_summary.json";
const W044_OPERATED_ASSURANCE_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w044-operated-assurance-retained-history-witness-slo-alert-service-001/validation.json";
const W044_OPERATED_SERVICE_ENVELOPE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w044-operated-assurance-retained-history-witness-slo-alert-service-001/w044_operated_service_envelope.json";
const W044_RETAINED_HISTORY_SERVICE_QUERY: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w044-operated-assurance-retained-history-witness-slo-alert-service-001/w044_retained_history_service_query.json";
const W044_RETAINED_WITNESS_LIFECYCLE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w044-operated-assurance-retained-history-witness-slo-alert-service-001/w044_retained_witness_lifecycle_register.json";
const W044_ALERT_DISPATCH_SERVICE: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w044-operated-assurance-retained-history-witness-slo-alert-service-001/w044_alert_dispatch_service_register.json";
const W044_CROSS_ENGINE_SERVICE_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w044-operated-assurance-retained-history-witness-slo-alert-service-001/w044_cross_engine_service_register.json";
const W044_SERVICE_READINESS_REGISTER: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w044-operated-assurance-retained-history-witness-slo-alert-service-001/w044_service_readiness_register.json";
const W044_OPERATED_SERVICE_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w044-operated-assurance-retained-history-witness-slo-alert-service-001/w044_exact_service_blocker_register.json";
const W044_OPERATED_PROMOTION_DECISION: &str = "archive/test-runs-core-engine-w038-w045/operated-assurance/w044-operated-assurance-retained-history-witness-slo-alert-service-001/promotion_decision.json";
const W044_PACK_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w044-pack-grade-replay-governance-service-c5-reassessment-001/run_summary.json";
const W044_PACK_DECISION: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w044-pack-grade-replay-governance-service-c5-reassessment-001/decision/pack_capability_decision.json";
...
const W045_RESIDUAL_MAP: &str = "archive/test-runs-core-engine-w038-w045/release-grade-ledger/w045-residual-release-grade-successor-obligation-current-oxfml-intake-map-001/successor_obligation_map.json";
...
const W045_OPTIMIZED_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/implementation-conformance/w045-optimized-core-counterpart-callable-metadata-001/run_summary.json";
const W045_OPTIMIZED_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/implementation-conformance/w045-optimized-core-counterpart-callable-metadata-001/validation.json";
const W045_DYNAMIC_TRANSITION_COVERAGE: &str = "archive/test-runs-core-engine-w038-w045/implementation-conformance/w045-optimized-core-counterpart-callable-metadata-001/w045_dynamic_transition_coverage_register.json";
const W045_OPTIMIZED_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/implementation-conformance/w045-optimized-core-counterpart-callable-metadata-001/w045_exact_remaining_blocker_register.json";
const W045_MATCH_PROMOTION_GUARD: &str = "archive/test-runs-core-engine-w038-w045/implementation-conformance/w045-optimized-core-counterpart-callable-metadata-001/w045_match_promotion_guard.json";
...
const W045_RUST_REFINEMENT: &str = "archive/test-runs-core-engine-w038-w045/formal-assurance/w045-rust-totality-refinement-panic-surface-hardening-001/w045_rust_refinement_register.json";
...
const W045_TLA_MODEL_BOUND: &str = "archive/test-runs-core-engine-w038-w045/formal-assurance/w045-lean-tla-verification-fairness-totality-discharge-001/w045_tla_model_bound_register.json";
...
const W045_STAGE2_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w045-stage2-production-partition-pack-grade-equivalence-service-001/run_summary.json";
const W045_STAGE2_VALIDATION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w045-stage2-production-partition-pack-grade-equivalence-service-001/validation.json";
const W045_STAGE2_DECISION: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w045-stage2-production-partition-pack-grade-equivalence-service-001/promotion_decision.json";
const W045_STAGE2_SERVICE_GATE: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w045-stage2-production-partition-pack-grade-equivalence-service-001/w045_stage2_service_gate_register.json";
const W045_STAGE2_BLOCKERS: &str = "archive/test-runs-core-engine-w038-w045/stage2-replay/w045-stage2-production-partition-pack-grade-equivalence-service-001/w045_stage2_exact_blocker_register.json";
const W043_PACK_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w043-pack-grade-replay-governance-c5-release-reassessment-001/run_summary.json";
const W043_PACK_DECISION: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w043-pack-grade-replay-governance-c5-release-reassessment-001/decision/pack_capability_decision.json";
const W042_PACK_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w042-pack-grade-replay-governance-c5-reassessment-001/run_summary.json";
const W042_PACK_DECISION: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w042-pack-grade-replay-governance-c5-reassessment-001/decision/pack_capability_decision.json";
const W040_PACK_SUMMARY: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w040-pack-grade-replay-governance-c5-promotion-decision-001/run_summary.json";
const W040_PACK_DECISION: &str = "archive/test-runs-core-engine-w038-w045/pack-capability/w040-pack-grade-replay-governance-c5-promotion-decision-001/decision/pack_capability_decision.json";
...
impl OperatedAssuranceRunner {
    ...
    fn execute_w045(
        ...
        let w045_residual_map = read_json(repo_root, W045_RESIDUAL_MAP)?;
        let w045_promotion_contract_map = read_json(repo_root, W045_PROMOTION_CONTRACT_MAP)?;
        let w045_oxfml_inbound_intake = read_json(repo_root, W045_OXFML_INBOUND_INTAKE)?;
        let w044_summary = read_json(repo_root, W044_OPERATED_ASSURANCE_SUMMARY)?;
        let w044_validation = read_json(repo_root, W044_OPERATED_ASSURANCE_VALIDATION)?;
        let w044_envelope = read_json(repo_root, W044_OPERATED_SERVICE_ENVELOPE)?;
        let w044_retained = read_json(repo_root, W044_RETAINED_HISTORY_SERVICE_QUERY)?;
        let w044_witness = read_json(repo_root, W044_RETAINED_WITNESS_LIFECYCLE)?;
        let w044_alerts = read_json(repo_root, W044_ALERT_DISPATCH_SERVICE)?;
        let w044_cross_engine = read_json(repo_root, W044_CROSS_ENGINE_SERVICE_REGISTER)?;
        let w044_readiness = read_json(repo_root, W044_SERVICE_READINESS_REGISTER)?;
        let w044_blockers = read_json(repo_root, W044_OPERATED_SERVICE_BLOCKERS)?;
        let w044_promotion = read_json(repo_root, W044_OPERATED_PROMOTION_DECISION)?;
        let w045_optimized_summary = read_json(repo_root, W045_OPTIMIZED_SUMMARY)?;
        let w045_optimized_validation = read_json(repo_root, W045_OPTIMIZED_VALIDATION)?;
        let w045_dynamic_transition = read_json(repo_root, W045_DYNAMIC_TRANSITION_COVERAGE)?;
        let w045_optimized_blockers = read_json(repo_root, W045_OPTIMIZED_BLOCKERS)?;
        let w045_match_guard = read_json(repo_root, W045_MATCH_PROMOTION_GUARD)?;
        let w045_rust_summary = read_json(repo_root, W045_RUST_SUMMARY)?;
        let w045_rust_validation = read_json(repo_root, W045_RUST_VALIDATION)?;
        let w045_rust_refinement = read_json(repo_root, W045_RUST_REFINEMENT)?;
        let w045_rust_blockers = read_json(repo_root, W045_RUST_BLOCKERS)?;
        let w045_lean_tla_summary = read_json(repo_root, W045_LEAN_TLA_SUMMARY)?;
        let w045_lean_tla_validation = read_json(repo_root, W045_LEAN_TLA_VALIDATION)?;
        let w045_tla_model_bound = read_json(repo_root, W045_TLA_MODEL_BOUND)?;
        let w045_lean_tla_blockers = read_json(repo_root, W045_LEAN_TLA_BLOCKERS)?;
        let w045_stage2_summary = read_json(repo_root, W045_STAGE2_SUMMARY)?;
        let w045_stage2_validation = read_json(repo_root, W045_STAGE2_VALIDATION)?;
        let w045_stage2_decision = read_json(repo_root, W045_STAGE2_DECISION)?;
        ...
        let source_rows = w045_source_rows(
            ...
            &w044_blockers,
            &w044_promotion,
            &w045_optimized_summary,
            &w045_optimized_validation,
            &w045_dynamic_transition,
            &w045_optimized_blockers,
            &w045_match_guard,
            &w045_rust_summary,
            &w045_rust_validation,
            &w045_rust_refinement,
            &w045_rust_blockers,
            &w045_lean_tla_summary,
            &w045_lean_tla_validation,
            &w045_tla_model_bound,
            &w045_lean_tla_blockers,
            &w045_stage2_summary,
            &w045_stage2_validation,
        ...
        let service_envelope =
            w045_operated_service_envelope(run_id, &relative_artifact_root, source_rows.len());
        let service_harness =
            w045_operated_service_harness(run_id, &relative_artifact_root, &service_envelope);
        let retained_history = w045_retained_history_service_query(
            run_id,
            &relative_artifact_root,
            &w044_retained,
            &w045_residual_map,
        ...
        let retained_witness_register = w045_retained_witness_lifecycle(
            run_id,
            &w044_witness,
            &w045_stage2_decision,
            &service_harness,
        );
        let alert_dispatcher = w045_alert_dispatch_service(
            run_id,
            &w044_alerts,
            &w044_promotion,
            &w045_stage2_decision,
        ...
        let cross_engine_service = w045_cross_engine_service(
            run_id,
            &w044_cross_engine,
            &w045_stage2_summary,
            &w045_stage2_service_gate,
        ...
        let readiness = w045_service_readiness(
            run_id,
            &relative_artifact_root,
            &service_envelope,
            &service_harness,
        ...
        let exact_blockers = w045_exact_service_blockers();
        let exact_service_blocker_count = exact_blockers.len();
        ...
        let service_envelope_path =
            format!("{relative_artifact_root}/w045_operated_service_envelope.json");
        let service_harness_path =
            format!("{relative_artifact_root}/w045_operated_service_harness_register.json");
        let retained_history_path =
            format!("{relative_artifact_root}/w045_retained_history_service_query.json");
        let retained_witness_path =
            format!("{relative_artifact_root}/w045_retained_witness_lifecycle_register.json");
        let alert_dispatcher_path =
            format!("{relative_artifact_root}/w045_alert_dispatch_service_register.json");
        let cross_engine_service_path =
            format!("{relative_artifact_root}/w045_cross_engine_service_register.json");
        let service_readiness_path =
            format!("{relative_artifact_root}/w045_service_readiness_register.json");
        let blocker_register_path =
            format!("{relative_artifact_root}/w045_exact_service_blocker_register.json");
        let promotion_decision_path = format!("{relative_artifact_root}/promotion_decision.json");
        let validation_path = format!("{relative_artifact_root}/validation.json");
        ...
        write_json(
            ...
            &json!({
                ...
                "source_artifacts": {
                    ...
                    "w045_residual_map": W045_RESIDUAL_MAP,
                    "w045_promotion_contract_map": W045_PROMOTION_CONTRACT_MAP,
                    "w045_oxfml_inbound_intake": W045_OXFML_INBOUND_INTAKE,
                    "w044_operated_assurance_summary": W044_OPERATED_ASSURANCE_SUMMARY,
                    "w044_operated_assurance_validation": W044_OPERATED_ASSURANCE_VALIDATION,
                    "w044_service_envelope": W044_OPERATED_SERVICE_ENVELOPE,
                    "w044_retained_history_service_query": W044_RETAINED_HISTORY_SERVICE_QUERY,
                    "w044_retained_witness_lifecycle": W044_RETAINED_WITNESS_LIFECYCLE,
                    "w044_alert_dispatch_service": W044_ALERT_DISPATCH_SERVICE,
                    "w044_cross_engine_service": W044_CROSS_ENGINE_SERVICE_REGISTER,
                    "w044_service_readiness": W044_SERVICE_READINESS_REGISTER,
                    "w044_exact_service_blockers": W044_OPERATED_SERVICE_BLOCKERS,
                    "w044_promotion_decision": W044_OPERATED_PROMOTION_DECISION,
                    "w045_optimized_summary": W045_OPTIMIZED_SUMMARY,
                    "w045_optimized_validation": W045_OPTIMIZED_VALIDATION,
                    "w045_dynamic_transition_coverage": W045_DYNAMIC_TRANSITION_COVERAGE,
                    "w045_optimized_blockers": W045_OPTIMIZED_BLOCKERS,
                    "w045_match_promotion_guard": W045_MATCH_PROMOTION_GUARD,
                    "w045_rust_summary": W045_RUST_SUMMARY,
                    "w045_rust_validation": W045_RUST_VALIDATION,
                    "w045_rust_refinement": W045_RUST_REFINEMENT,
                    "w045_rust_blockers": W045_RUST_BLOCKERS,
                    "w045_lean_tla_summary": W045_LEAN_TLA_SUMMARY,
                    "w045_lean_tla_validation": W045_LEAN_TLA_VALIDATION,
                    "w045_tla_model_bound": W045_TLA_MODEL_BOUND,
                    "w045_lean_tla_blockers": W045_LEAN_TLA_BLOCKERS,
                    "w045_stage2_summary": W045_STAGE2_SUMMARY,
                    "w045_stage2_validation": W045_STAGE2_VALIDATION,
                    "w045_stage2_decision": W045_STAGE2_DECISION,
                    "w045_stage2_service_gate": W045_STAGE2_SERVICE_GATE,
                    "w045_stage2_blockers": W045_STAGE2_BLOCKERS,
                    "w044_pack_summary": W044_PACK_SUMMARY,
                    "w044_pack_decision": W044_PACK_DECISION
                }
            }),
        )?;
        write_json(
            &artifact_root.join("w045_operated_service_envelope.json"),
            &service_envelope,
        )?;
        write_json(
            &artifact_root.join("w045_operated_service_harness_register.json"),
            &service_harness,
        )?;
        write_json(
            &artifact_root.join("w045_retained_history_service_query.json"),
            &retained_history,
        )?;
        write_json(
            &artifact_root.join("w045_retained_witness_lifecycle_register.json"),
            &retained_witness_register,
        )?;
        write_json(
            &artifact_root.join("w045_alert_dispatch_service_register.json"),
            &alert_dispatcher,
        )?;
        write_json(
            &artifact_root.join("w045_cross_engine_service_register.json"),
            &cross_engine_service,
        )?;
        write_json(
            &artifact_root.join("w045_service_readiness_register.json"),
            &readiness,
        )?;
        write_json(
            &artifact_root.join("w045_exact_service_blocker_register.json"),
            &json!({
        ...
        write_json(
            ...
            &json!({
                ...
                "run_id": run_id,
                "decision_state": "w045_operated_assurance_retained_history_retained_witness_slo_service_validated_local_harness_services_unpromoted",
                "local_operated_service_harness_runnable": bool_at(&service_harness, "local_harness_runnable"),
                "local_operated_service_harness_operation_count": number_at(&service_harness, "operation_count"),
                ...
                "w073_downstream_typed_rule_request_construction_required": bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "downstream_typed_rule_request_construction_required"),
                "w073_downstream_typed_rule_request_construction_verified": bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "downstream_uptake_verified_by_oxcalc"),
                "operated_continuous_assurance_service_promoted": false,
                ...
                "service_readiness_blocked_count": number_at(&readiness, "blocked_criteria_count"),
                "exact_service_blocker_count": exact_service_blocker_count,
                "blockers": w045_exact_service_blockers()
                    .iter()
                    .map(|row| row["blocker_id"].clone())
                    .collect::<Vec<_>>(),
                "semantic_equivalence_statement": "This W045 runner emits an operated-assurance retained-history, retained-witness, SLO, and alert-service packet by binding W045 residual obligations, current W073 typed-only OxFml formatting intake, W044 operated-assurance predecessor evidence, W045 optimized/core dynamic evidence, W045 Rust and Lean/TLA proof/model evidence, W045 Stage 2 service gates, W044 pack blockers, retained-history query rows, retained-witness lifecycle rows, and local alert/quarantine rules. The new local harness is runnable evidence for artifact orchestration only; it does not change scheduler, recalc, publication, replay, pack, service, alert-dispatch, TraceCalc, TreeCalc, OxFml, OxFunc, Lean, or TLA semantics."
            }),
        )?;
        write_json(
            ...
            &json!({
                ...
                "status": if source_failures.is_empty() {
                    "w045_operated_assurance_retained_history_retained_witness_slo_service_valid"
                } else {
                    "w045_operated_assurance_retained_history_retained_witness_slo_service_invalid"
                },
                "source_evidence_row_count": source_rows.len(),
                "service_envelope_row_count": number_at(&service_envelope, "row_count"),
                "service_harness_operation_count": number_at(&service_harness, "operation_count"),
        ...
        write_json(
            ...
            &json!({
                ...
                "service_harness_register_path": service_harness_path,
    ...
    fn execute_w044(
        ...
        let w044_residual_map = read_json(repo_root, W044_RESIDUAL_MAP)?;
        let w044_oxfml_inbound_intake = read_json(repo_root, W044_OXFML_INBOUND_INTAKE)?;
        let w043_summary = read_json(repo_root, W043_OPERATED_ASSURANCE_SUMMARY)?;
        let w043_validation = read_json(repo_root, W043_OPERATED_ASSURANCE_VALIDATION)?;
        let w043_envelope = read_json(repo_root, W043_OPERATED_SERVICE_ENVELOPE)?;
        let w043_retained = read_json(repo_root, W043_RETAINED_HISTORY_SERVICE_QUERY)?;
        let w043_witness = read_json(repo_root, W043_RETAINED_WITNESS_LIFECYCLE)?;
        let w043_alerts = read_json(repo_root, W043_ALERT_DISPATCH_SERVICE)?;
        let w043_cross_engine = read_json(repo_root, W043_CROSS_ENGINE_SERVICE_REGISTER)?;
        let w043_readiness = read_json(repo_root, W043_SERVICE_READINESS_REGISTER)?;
        let w043_blockers = read_json(repo_root, W043_OPERATED_SERVICE_BLOCKERS)?;
        let w043_promotion = read_json(repo_root, W043_OPERATED_PROMOTION_DECISION)?;
        let w044_optimized_summary = read_json(repo_root, W044_OPTIMIZED_SUMMARY)?;
        let w044_optimized_validation = read_json(repo_root, W044_OPTIMIZED_VALIDATION)?;
        let w044_dynamic_transition = read_json(repo_root, W044_DYNAMIC_TRANSITION_EVIDENCE)?;
        let w044_optimized_blockers = read_json(repo_root, W044_OPTIMIZED_BLOCKERS)?;
        ...
        let w044_rust_refinement = read_json(repo_root, W044_RUST_REFINEMENT)?;
        let w044_rust_blockers = read_json(repo_root, W044_RUST_BLOCKERS)?;
        ...
        let w044_tla_model_bound = read_json(repo_root, W044_TLA_MODEL_BOUND)?;
        let w044_lean_tla_blockers = read_json(repo_root, W044_LEAN_TLA_BLOCKERS)?;
        let w044_stage2_summary = read_json(repo_root, W044_STAGE2_SUMMARY)?;
        let w044_stage2_validation = read_json(repo_root, W044_STAGE2_VALIDATION)?;
        let w044_stage2_decision = read_json(repo_root, W044_STAGE2_DECISION)?;
        let w044_stage2_blockers = read_json(repo_root, W044_STAGE2_BLOCKERS)?;
        let w043_pack_summary = read_json(repo_root, W043_PACK_SUMMARY)?;
        let w043_pack_decision = read_json(repo_root, W043_PACK_DECISION)?;

        let source_rows = w044_source_rows(
            &w044_residual_summary,
            &w044_residual_map,
            &w044_oxfml_inbound_intake,
            &w043_summary,
            &w043_validation,
            &w043_envelope,
            &w043_retained,
            ...
            &w044_optimized_validation,
            &w044_dynamic_transition,
            &w044_optimized_blockers,
            &w044_rust_summary,
            &w044_rust_validation,
            &w044_rust_refinement,
            &w044_rust_blockers,
            &w044_lean_tla_summary,
            &w044_lean_tla_validation,
            &w044_tla_model_bound,
            &w044_lean_tla_blockers,
            &w044_stage2_summary,
            &w044_stage2_validation,
            &w044_stage2_decision,
            &w044_stage2_blockers,
            &w043_pack_summary,
            &w043_pack_decision,
        );
        let source_failures = w039_source_validation_failures(&source_rows);
        let service_envelope =
            w044_operated_service_envelope(run_id, &relative_artifact_root, source_rows.len());
        let retained_history = w044_retained_history_service_query(
            run_id,
            &relative_artifact_root,
            &w043_retained,
            &w044_residual_map,
        ...
        let retained_witness_register =
            w044_retained_witness_lifecycle(run_id, &w043_witness, &w044_stage2_decision);
        let alert_dispatcher = w044_alert_dispatch_service(
            run_id,
            &w043_alerts,
            &w043_promotion,
            &w044_stage2_decision,
        ...
        let cross_engine_service = w044_cross_engine_service(
            run_id,
            &w043_cross_engine,
            &w044_stage2_summary,
            &w044_stage2_blockers,
        );
        let readiness = w044_service_readiness(
            run_id,
            &relative_artifact_root,
            &service_envelope,
            &retained_history,
        ...
        let exact_blockers = w044_exact_service_blockers();
        let exact_service_blocker_count = exact_blockers.len();
        let failed_row_count = source_failures.len();
        ...
        let source_evidence_index_path =
            format!("{relative_artifact_root}/source_evidence_index.json");
        let service_envelope_path =
            format!("{relative_artifact_root}/w044_operated_service_envelope.json");
        let retained_history_path =
            format!("{relative_artifact_root}/w044_retained_history_service_query.json");
        let retained_witness_path =
            format!("{relative_artifact_root}/w044_retained_witness_lifecycle_register.json");
        let alert_dispatcher_path =
            format!("{relative_artifact_root}/w044_alert_dispatch_service_register.json");
        let cross_engine_service_path =
            format!("{relative_artifact_root}/w044_cross_engine_service_register.json");
        let service_readiness_path =
            format!("{relative_artifact_root}/w044_service_readiness_register.json");
        let blocker_register_path =
            format!("{relative_artifact_root}/w044_exact_service_blocker_register.json");
        let promotion_decision_path = format!("{relative_artifact_root}/promotion_decision.json");
        let validation_path = format!("{relative_artifact_root}/validation.json");
        ...
        write_json(
            ...
            &json!({
                ...
                "source_artifacts": {
                    ...
                    "w044_residual_map": W044_RESIDUAL_MAP,
                    "w044_oxfml_inbound_intake": W044_OXFML_INBOUND_INTAKE,
                    "w043_operated_assurance_summary": W043_OPERATED_ASSURANCE_SUMMARY,
                    "w043_operated_assurance_validation": W043_OPERATED_ASSURANCE_VALIDATION,
                    "w043_service_envelope": W043_OPERATED_SERVICE_ENVELOPE,
                    "w043_retained_history_service_query": W043_RETAINED_HISTORY_SERVICE_QUERY,
                    "w043_retained_witness_lifecycle": W043_RETAINED_WITNESS_LIFECYCLE,
                    "w043_alert_dispatch_service": W043_ALERT_DISPATCH_SERVICE,
                    "w043_cross_engine_service": W043_CROSS_ENGINE_SERVICE_REGISTER,
                    "w043_service_readiness": W043_SERVICE_READINESS_REGISTER,
                    "w043_exact_service_blockers": W043_OPERATED_SERVICE_BLOCKERS,
                    "w043_promotion_decision": W043_OPERATED_PROMOTION_DECISION,
                    "w044_optimized_summary": W044_OPTIMIZED_SUMMARY,
                    "w044_optimized_validation": W044_OPTIMIZED_VALIDATION,
                    "w044_dynamic_transition_evidence": W044_DYNAMIC_TRANSITION_EVIDENCE,
                    "w044_optimized_blockers": W044_OPTIMIZED_BLOCKERS,
                    "w044_rust_summary": W044_RUST_SUMMARY,
                    "w044_rust_validation": W044_RUST_VALIDATION,
                    "w044_rust_refinement": W044_RUST_REFINEMENT,
                    "w044_rust_blockers": W044_RUST_BLOCKERS,
                    "w044_lean_tla_summary": W044_LEAN_TLA_SUMMARY,
                    "w044_lean_tla_validation": W044_LEAN_TLA_VALIDATION,
                    "w044_tla_model_bound": W044_TLA_MODEL_BOUND,
                    "w044_lean_tla_blockers": W044_LEAN_TLA_BLOCKERS,
                    "w044_stage2_summary": W044_STAGE2_SUMMARY,
                    "w044_stage2_validation": W044_STAGE2_VALIDATION,
                    "w044_stage2_decision": W044_STAGE2_DECISION,
                    "w044_stage2_blockers": W044_STAGE2_BLOCKERS,
                    "w043_pack_summary": W043_PACK_SUMMARY,
                    "w043_pack_decision": W043_PACK_DECISION
                }
            }),
        )?;
        write_json(
            &artifact_root.join("w044_operated_service_envelope.json"),
            &service_envelope,
        )?;
        write_json(
            &artifact_root.join("w044_retained_history_service_query.json"),
            &retained_history,
        )?;
        write_json(
            &artifact_root.join("w044_retained_witness_lifecycle_register.json"),
            &retained_witness_register,
        )?;
        write_json(
            &artifact_root.join("w044_alert_dispatch_service_register.json"),
            &alert_dispatcher,
        )?;
        write_json(
            &artifact_root.join("w044_cross_engine_service_register.json"),
            &cross_engine_service,
        )?;
        write_json(
            &artifact_root.join("w044_service_readiness_register.json"),
            &readiness,
        )?;
        write_json(
            &artifact_root.join("w044_exact_service_blocker_register.json"),
            &json!({
        ...
        write_json(
            ...
            &json!({
                ...
                "run_id": run_id,
                "decision_state": "w044_operated_assurance_retained_history_witness_slo_alert_service_validated_services_unpromoted",
                "file_backed_service_envelope_present": true,
                "service_run_queue_manifest_present": bool_at(&service_envelope, "service_run_queue_manifest_present"),
                "retained_history_query_api_contract_present": bool_at(&retained_history, "retained_history_query_api_contract_present"),
                "replay_correlation_index_present": bool_at(&retained_history, "replay_correlation_index_present"),
                ...
                "external_alert_dispatcher_contract_present": bool_at(&alert_dispatcher, "external_alert_dispatcher_contract_present"),
                "w073_typed_rule_only_formatting_guard_carried": bool_at(&readiness, "w073_typed_rule_only_formatting_guard_carried"),
                "w073_downstream_typed_rule_request_construction_required": bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "downstream_typed_rule_request_construction_required"),
                "w073_downstream_typed_rule_request_construction_verified": bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "downstream_uptake_verified_by_oxcalc"),
                "operated_continuous_assurance_service_promoted": false,
                "retained_history_service_promoted": false,
                "retained_witness_lifecycle_service_promoted": false,
                "retention_slo_enforcement_promoted": false,
                ...
                "service_readiness_blocked_count": number_at(&readiness, "blocked_criteria_count"),
                "exact_service_blocker_count": exact_service_blocker_count,
                "blockers": w044_exact_service_blockers()
                    .iter()
                    .map(|row| row["blocker_id"].clone())
                    .collect::<Vec<_>>(),
                "semantic_equivalence_statement": "This W044 runner emits an operated-assurance retained-history, retained-witness, SLO, and alert-service packet by binding W044 residual obligations, W044 typed-only OxFml formatting intake, W043 service-envelope evidence, W044 optimized/core dynamic evidence, W044 Rust and Lean/TLA proof/model evidence, W044 Stage 2 service blockers, W043 pack blockers, retained-history query rows, retained-witness lifecycle rows, and local alert/quarantine rules. It does not change scheduler, recalc, publication, replay, pack, service, alert-dispatch, TraceCalc, TreeCalc, OxFml, OxFunc, Lean, or TLA semantics."
            }),
        )?;
        write_json(
            &artifact_root.join("validation.json"),
            &json!({
                ...
                "run_id": run_id,
                "status": if source_failures.is_empty() {
                    "w044_operated_assurance_retained_history_witness_slo_alert_service_valid"
                } else {
                    "w044_operated_assurance_retained_history_witness_slo_alert_service_invalid"
                },
                "source_evidence_row_count": source_rows.len(),
                "service_envelope_row_count": number_at(&service_envelope, "row_count"),
                "multi_run_history_row_count": number_at(&retained_history, "store_record_count"),
...
#[allow(clippy::too_many_arguments)]
fn w044_source_rows(
    w044_residual_summary: &Value,
    w044_residual_map: &Value,
    w044_oxfml_inbound_intake: &Value,
    w043_summary: &Value,
    w043_validation: &Value,
    w043_envelope: &Value,
    w043_retained: &Value,
    w043_witness: &Value,
    w043_alerts: &Value,
    w043_cross_engine: &Value,
    w043_readiness: &Value,
    w043_blockers: &Value,
    w043_promotion: &Value,
    w044_optimized_summary: &Value,
    w044_optimized_validation: &Value,
    w044_dynamic_transition: &Value,
    w044_optimized_blockers: &Value,
    w044_rust_summary: &Value,
    w044_rust_validation: &Value,
    w044_rust_refinement: &Value,
    w044_rust_blockers: &Value,
    w044_lean_tla_summary: &Value,
    w044_lean_tla_validation: &Value,
    w044_tla_model_bound: &Value,
    w044_lean_tla_blockers: &Value,
    w044_stage2_summary: &Value,
    w044_stage2_validation: &Value,
    w044_stage2_decision: &Value,
    w044_stage2_blockers: &Value,
    w043_pack_summary: &Value,
    w043_pack_decision: &Value,
) -> Vec<Value> {
    vec![
        json!({
            "row_id": "source.w044_residual_release_grade_blocker_map",
            "artifact": W044_RESIDUAL_MAP,
            "valid": text_at(w044_residual_summary, "status") == "residual_release_grade_blocker_reclassification_map_validated"
                && number_at(w044_residual_summary, "obligation_count") == 45
                && number_at(w044_residual_map, "source_residual_lane_count") == 20
                && number_at(w044_residual_map, "obligation_count") == 45,
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": false,
            "semantic_state": "w044_operated_service_obligations_bound"
        }),
        json!({
            "row_id": "source.w044_oxfml_w073_inbound_update",
            "artifact": W044_OXFML_INBOUND_INTAKE,
            "valid": array_len(&w044_oxfml_inbound_intake["w073_formatting"]["typed_rule_only_families"]) == 7
                && !bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "threshold_fallback_allowed_for_typed_families")
                && bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "old_bounded_string_non_interpretation_evidence_reviewed")
                && bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "downstream_typed_rule_request_construction_required")
                && !bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "downstream_uptake_verified_by_oxcalc")
                && !bool_at(w044_oxfml_inbound_intake, "handoff_required"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": false,
            "semantic_state": "latest_oxfml_w073_typed_only_update_carried_as_w044_watch_row"
        }),
        json!({
            "row_id": "source.w043_operated_assurance_predecessor_summary",
            "artifact": W043_OPERATED_ASSURANCE_SUMMARY,
            "valid": text_at(w043_validation, "status") == "w043_operated_assurance_retained_history_witness_slo_alert_service_valid"
                && number_at(w043_summary, "source_evidence_row_count") == 15
                && number_at(w043_summary, "exact_service_blocker_count") == 6
                && number_at(w043_summary, "failed_row_count") == 0,
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w043_summary, "failed_row_count"),
            "promoted_unsupported_service": bool_at(w043_promotion, "operated_continuous_assurance_service_promoted")
                || bool_at(w043_promotion, "retained_history_service_promoted")
                || bool_at(w043_promotion, "retained_witness_lifecycle_service_promoted")
                || bool_at(w043_promotion, "retention_slo_enforcement_promoted")
                || bool_at(w043_promotion, "external_alert_dispatcher_promoted")
                || bool_at(w043_promotion, "operated_cross_engine_differential_service_promoted"),
            "semantic_state": "w043_service_packet_bound_without_service_promotion"
        }),
        json!({
            "row_id": "source.w043_service_envelope",
            "artifact": W043_OPERATED_SERVICE_ENVELOPE,
            "valid": bool_at(w043_envelope, "file_backed_service_envelope_present")
                && bool_at(w043_envelope, "service_run_queue_manifest_present")
                && !bool_at(w043_envelope, "operated_run_queue_present")
                && !bool_at(w043_envelope, "service_endpoint_present"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w043_envelope, "operated_run_queue_present")
                || bool_at(w043_envelope, "service_endpoint_present"),
            "semantic_state": "w043_file_backed_service_envelope_available_for_w044"
        }),
        json!({
            "row_id": "source.w043_retained_history_query_contract",
            "artifact": W043_RETAINED_HISTORY_SERVICE_QUERY,
            "valid": number_at(w043_retained, "store_record_count") == 33
                && number_at(w043_retained, "query_register_row_count") == 13
                && number_at(w043_retained, "replay_correlation_row_count") == 11
                && bool_at(w043_retained, "retained_history_query_api_contract_present")
                && bool_at(w043_retained, "replay_correlation_index_present")
                && !bool_at(w043_retained, "retained_history_service_operated")
                && !bool_at(w043_retained, "retention_slo_enforced"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w043_retained, "retained_history_service_operated")
                || bool_at(w043_retained, "retained_history_service_promoted"),
            "semantic_state": "w043_retained_history_query_contract_bound_for_w044"
        }),
        json!({
            "row_id": "source.w043_retained_witness_lifecycle",
            "artifact": W043_RETAINED_WITNESS_LIFECYCLE,
            "valid": bool_at(w043_witness, "retained_witness_lifecycle_register_present")
                && number_at(w043_witness, "witness_lifecycle_row_count") == 8
                && number_at(w043_witness, "pack_eligible_witness_count") == 0
                && !bool_at(w043_witness, "retained_witness_lifecycle_service_promoted")
                && !bool_at(w043_witness, "retention_slo_enforced"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w043_witness, "retained_witness_lifecycle_service_promoted")
                || number_at(w043_witness, "pack_eligible_witness_count") > 0,
            "semantic_state": "w043_retained_witness_lifecycle_bound_without_pack_eligibility"
        }),
        json!({
            "row_id": "source.w043_alert_dispatch_contract",
            "artifact": W043_ALERT_DISPATCH_SERVICE,
            "valid": number_at(w043_alerts, "evaluated_rule_count") == 29
                && number_at(w043_alerts, "quarantine_decision_count") == 0
                && number_at(w043_alerts, "alert_decision_count") == 0
                && bool_at(w043_alerts, "local_alert_dispatcher_evaluated")
                && bool_at(w043_alerts, "external_alert_dispatcher_contract_present"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w043_alerts, "quarantine_decision_count"),
            "promoted_unsupported_service": bool_at(w043_alerts, "external_alert_dispatcher_promoted")
                || bool_at(w043_alerts, "quarantine_service_promoted"),
            "semantic_state": "w043_local_alert_dispatch_contract_clean_for_w044"
        }),
        json!({
            "row_id": "source.w043_cross_engine_service_blocker",
            "artifact": W043_CROSS_ENGINE_SERVICE_REGISTER,
            "valid": bool_at(w043_cross_engine, "file_backed_cross_engine_substrate_present")
                && bool_at(w043_cross_engine, "w043_stage2_service_dependency_blocker_present")
                && !bool_at(w043_cross_engine, "operated_cross_engine_differential_service_present")
                && !bool_at(w043_cross_engine, "service_endpoint_present"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w043_cross_engine, "operated_cross_engine_differential_service_promoted"),
            "semantic_state": "w043_cross_engine_file_backed_substrate_bound"
        }),
        json!({
            "row_id": "source.w043_service_readiness_blockers",
            "artifact": W043_SERVICE_READINESS_REGISTER,
            "valid": number_at(w043_readiness, "blocked_criteria_count") == 6
                && number_at(w043_blockers, "exact_service_blocker_count") == 6
                && bool_at(w043_readiness, "w073_typed_rule_only_formatting_guard_carried"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w043_readiness, "operated_continuous_assurance_service_promoted")
                || bool_at(w043_readiness, "retained_history_service_promoted")
                || bool_at(w043_readiness, "retained_witness_lifecycle_service_promoted")
                || bool_at(w043_readiness, "external_alert_dispatcher_promoted")
                || bool_at(w043_readiness, "cross_engine_differential_service_promoted"),
            "semantic_state": "w043_exact_service_blockers_bound_for_w044"
        }),
        json!({
            "row_id": "source.w044_optimized_core_mixed_dynamic_service_input",
            "artifact": W044_DYNAMIC_TRANSITION_EVIDENCE,
            "valid": text_at(w044_optimized_validation, "status") == "implementation_conformance_w044_dynamic_transition_callable_metadata_valid"
                && number_at(w044_optimized_summary, "failed_row_count") == 0
                && number_at(w044_optimized_summary, "w044_exact_remaining_blocker_count") == 4
                && bool_at(w044_dynamic_transition, "direct_evidence_bound")
                && array_contains_string(&w044_dynamic_transition["observed_seed_reasons"], "DependencyAdded")
                && array_contains_string(&w044_dynamic_transition["observed_seed_reasons"], "DependencyRemoved")
                && array_contains_string(&w044_dynamic_transition["observed_seed_reasons"], "DependencyReclassified")
                && number_at(w044_optimized_blockers, "exact_remaining_blocker_count") == 4,
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w044_optimized_summary, "failed_row_count"),
            "promoted_unsupported_service": number_at(w044_optimized_summary, "w044_match_promoted_count") > 0,
            "semantic_state": "w044_mixed_dynamic_transition_bound_as_service_input_without_optimized_core_promotion"
        }),
        json!({
            "row_id": "source.w044_rust_refinement_service_bridge",
            "artifact": W044_RUST_REFINEMENT,
            "valid": text_at(w044_rust_validation, "status") == "formal_assurance_w044_rust_totality_refinement_valid"
                && number_at(w044_rust_summary, "failed_row_count") == 0
                && number_at(w044_rust_summary, "exact_remaining_blocker_count") == 6
                && number_at(w044_rust_refinement, "refinement_row_count") == 9
                && number_at(w044_rust_blockers, "exact_remaining_blocker_count") == 6
                && bool_at(w044_rust_validation, "mixed_dynamic_no_publication_verified"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w044_rust_summary, "failed_row_count"),
            "promoted_unsupported_service": bool_at(&w044_rust_summary["promotion_claims"], "rust_engine_totality_promoted")
                || bool_at(&w044_rust_summary["promotion_claims"], "rust_refinement_promoted")
                || bool_at(&w044_rust_summary["promotion_claims"], "panic_free_core_domain_promoted"),
            "semantic_state": "w044_rust_refinement_no_publication_bridge_bound_without_totality_promotion"
        }),
        json!({
            "row_id": "source.w044_lean_tla_model_bound_service_bridge",
            "artifact": W044_TLA_MODEL_BOUND,
            "valid": text_at(w044_lean_tla_validation, "status") == "formal_assurance_w044_lean_tla_fairness_valid"
                && number_at(w044_lean_tla_summary, "failed_row_count") == 0
                && number_at(w044_lean_tla_summary, "exact_remaining_blocker_count") == 5
                && number_at(w044_tla_model_bound, "bounded_model_row_count") == 4
                && number_at(w044_lean_tla_blockers, "exact_remaining_blocker_count") == 5,
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w044_lean_tla_summary, "failed_row_count"),
            "promoted_unsupported_service": bool_at(&w044_lean_tla_summary["promotion_claims"], "full_tla_verification_promoted")
                || bool_at(&w044_lean_tla_summary["promotion_claims"], "scheduler_fairness_promoted")
                || bool_at(&w044_lean_tla_summary["promotion_claims"], "unbounded_model_coverage_promoted"),
            "semantic_state": "w044_lean_tla_bounded_model_bound_without_unbounded_scheduler_promotion"
        }),
        json!({
            "row_id": "source.w044_stage2_service_dependency",
            "artifact": W044_STAGE2_SUMMARY,
            "valid": text_at(w044_stage2_validation, "status") == "w044_stage2_scheduler_equivalence_valid"
                && number_at(w044_stage2_summary, "failed_row_count") == 0
                && number_at(w044_stage2_summary, "exact_remaining_blocker_count") == 8
                && bool_at(w044_stage2_summary, "production_relevant_analyzer_inputs_evidenced")
                && row_with_field_exists(
                    w044_stage2_blockers,
                    "row_id",
                    "w044_stage2_operated_cross_engine_service_dependency_blocker"
                ),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w044_stage2_summary, "failed_row_count"),
            "promoted_unsupported_service": bool_at(w044_stage2_decision, "operated_cross_engine_stage2_service_promoted")
                || bool_at(w044_stage2_decision, "stage2_policy_promoted"),
            "semantic_state": "w044_stage2_service_dependency_bound"
        }),
        json!({
            "row_id": "source.w044_stage2_retained_witness_dependency",
            "artifact": W044_STAGE2_BLOCKERS,
            "valid": row_with_field_exists(
                    w044_stage2_blockers,
                    "row_id",
                    "w044_stage2_retained_witness_lifecycle_pack_dependency_blocker"
                )
                && !bool_at(w044_stage2_decision, "retained_witness_lifecycle_promoted"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w044_stage2_decision, "retained_witness_lifecycle_promoted"),
            "semantic_state": "w044_stage2_retained_witness_dependency_retained"
        }),
        json!({
            "row_id": "source.w044_stage2_pack_governance_dependency",
            "artifact": W044_STAGE2_BLOCKERS,
            "valid": row_with_field_exists(
                    w044_stage2_blockers,
                    "row_id",
                    "w044_stage2_pack_grade_replay_governance_blocker"
                )
                && !bool_at(w044_stage2_decision, "pack_grade_replay_governance_promoted"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w044_stage2_decision, "pack_grade_replay_governance_promoted")
                || bool_at(w044_stage2_decision, "pack_grade_replay_promoted"),
            "semantic_state": "w044_pack_governance_dependency_retained"
        }),
        json!({
            "row_id": "source.w043_pack_c5_service_blockers",
            "artifact": W043_PACK_DECISION,
            "valid": text_at(w043_pack_decision, "decision_status") == "capability_not_promoted"
                && !bool_at(w043_pack_decision, "capability_promoted")
                && number_at(w043_pack_decision, "missing_artifact_count") == 0
                && number_at(w043_pack_summary, "missing_artifact_count") == 0
                && array_contains_string(&w043_pack_decision["no_promotion_reason_ids"], "pack.grade.w043_operated_continuous_assurance_service_absent")
                && array_contains_string(&w043_pack_decision["no_promotion_reason_ids"], "pack.grade.w043_retained_history_service_absent")
                && array_contains_string(&w043_pack_decision["no_promotion_reason_ids"], "pack.grade.w043_retained_witness_lifecycle_service_absent")
                && array_contains_string(&w043_pack_decision["no_promotion_reason_ids"], "pack.grade.w043_retention_slo_not_enforced")
                && array_contains_string(&w043_pack_decision["no_promotion_reason_ids"], "pack.grade.w043_external_alert_dispatcher_absent")
                && array_contains_string(&w043_pack_decision["no_promotion_reason_ids"], "pack.grade.w043_operated_cross_engine_diff_service_absent"),
            "missing_artifact_count": number_at(w043_pack_decision, "missing_artifact_count"),
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w043_pack_summary, "missing_artifact_count"),
            "promoted_unsupported_service": bool_at(w043_pack_decision, "capability_promoted"),
            "semantic_state": "w043_pack_c5_service_no_promotion_blockers_bound"
        }),
        json!({
            "row_id": "source.w044_no_proxy_promotion_guard",
            "artifact": W044_STAGE2_DECISION,
            "valid": !bool_at(w043_promotion, "operated_continuous_assurance_service_promoted")
                && !bool_at(w043_promotion, "retained_history_service_promoted")
                && !bool_at(w043_promotion, "retained_witness_lifecycle_service_promoted")
                && !bool_at(w043_promotion, "retention_slo_enforcement_promoted")
                && !bool_at(w043_promotion, "external_alert_dispatcher_promoted")
            ...
            "promoted_unsupported_service": bool_at(w043_promotion, "operated_continuous_assurance_service_promoted")
                ...
                || bool_at(w044_stage2_decision, "pack_grade_replay_promoted")
                || bool_at(w043_pack_decision, "capability_promoted"),
            "semantic_state": "w044_service_stage2_pack_formatting_no_proxy_promotion_guard_clean"
        }),
    ]
}

fn w044_operated_service_envelope(
    run_id: &str,
    relative_artifact_root: &str,
    source_evidence_row_count: usize,
) -> Value {
    let rows = vec![
        json!({
            ...
            "state": "satisfied",
            "runner_command": format!("cargo run -p oxcalc-tracecalc-cli -- operated-assurance {run_id}"),
            "evidence_or_blocker": "W044 operated-assurance packet is emitted by the checked CLI runner"
        }),
        json!({
            "row_id": "service.artifact_root",
            "state": "satisfied",
        ...
        json!({
            ...
            "state": "satisfied",
            "source_evidence_row_count": source_evidence_row_count,
            "evidence_or_blocker": "runner binds W044 residual obligations, W043 service packet, W044 proof/model and Stage 2 artifacts, W043 pack decision, and W073 typed-formatting intake"
        }),
        json!({
            "row_id": "service.run_queue_manifest",
            "state": "satisfied_boundary",
        ...
        json!({
            "row_id": "service.stage2_service_dependency_bound",
            "state": "satisfied",
            "evidence_or_blocker": "W044 Stage 2 retains operated cross-engine differential service as an exact dependency"
        }),
        json!({
            "row_id": "service.oxfml_formatting_watch",
            "state": "satisfied",
    ...
    json!({
        "schema_version": W044_SERVICE_ENVELOPE_SCHEMA_V1,
        "run_id": run_id,
        "artifact_root": relative_artifact_root,
        "runner_kind": "file_backed_operated_assurance_retained_history_witness_slo_alert_service",
        "runner_command": format!("cargo run -p oxcalc-tracecalc-cli -- operated-assurance {run_id}"),
...
#[allow(clippy::too_many_arguments)]
fn w044_retained_history_service_query(
    run_id: &str,
    relative_artifact_root: &str,
    w043_retained: &Value,
    w044_residual_map: &Value,
    ...
    rows.push(history_row(
        next_order,
        "w044.residual_release_grade_blocker_map",
        "w044_residual_release_grade_blocker_map",
        "w044_operated_service_obligations_bound",
        W044_RESIDUAL_MAP,
        0,
        0,
        number_at(w044_residual_map, "source_residual_lane_count"),
    ));
    rows.push(history_row(
        next_order + 1,
        "w044.optimized_core_mixed_dynamic_transition",
        "w044_optimized_core_service_input",
        "mixed_dynamic_transition_bound_with_retained_optimized_core_blockers",
        W044_OPTIMIZED_SUMMARY,
        number_at(w044_optimized_summary, "failed_row_count"),
        0,
        number_at(w044_optimized_summary, "w044_exact_remaining_blocker_count"),
    ));
    rows.push(history_row(
        next_order + 2,
        "w044.rust_totality_refinement_bridge",
        "w044_rust_refinement_service_bridge",
        "rust_refinement_and_no_publication_bridge_bound_with_totality_blockers",
        W044_RUST_SUMMARY,
        number_at(w044_rust_summary, "failed_row_count"),
        0,
        number_at(w044_rust_summary, "exact_remaining_blocker_count"),
    ));
    rows.push(history_row(
        next_order + 3,
        "w044.lean_tla_model_bound_bridge",
        "w044_lean_tla_model_bound_service_bridge",
        "bounded_lean_tla_model_bound_bridge_retained_with_fairness_blockers",
        W044_LEAN_TLA_SUMMARY,
        number_at(w044_lean_tla_summary, "failed_row_count"),
        0,
        number_at(w044_lean_tla_summary, "exact_remaining_blocker_count"),
    ));
    rows.push(history_row(
        next_order + 4,
        "w044.stage2_scheduler_equivalence",
        "w044_stage2_service_dependency",
        "stage2_scheduler_equivalence_bound_with_service_retained_witness_and_pack_blockers",
        W044_STAGE2_SUMMARY,
        number_at(w044_stage2_summary, "failed_row_count"),
        0,
        number_at(w044_stage2_summary, "exact_remaining_blocker_count"),
    ));
    rows.push(history_row(
        next_order + 5,
        "w043.pack_c5_decision",
        "w043_pack_c5_service_blockers",
        "pack_c5_decision_retains_service_retained_witness_slo_and_program_grade_governance_blockers",
        W043_PACK_DECISION,
        0,
        0,
        array_len(&w043_pack_decision["no_promotion_reason_ids"]) as u64,
    ));
    rows.push(history_row(
        next_order + 6,
        "w044.w073_formatting_intake",
        "w044_w073_typed_formatting_guard",
        "typed_only_formatting_guard_retained_in_operated_assurance_history",
        W044_OXFML_INBOUND_INTAKE,
        0,
        0,
        if bool_at(
            &w044_oxfml_inbound_intake["w073_formatting"],
            "threshold_fallback_allowed_for_typed_families",
        ) {
            1
        } else {
    ...
    let mut query_register = w043_retained
        .get("query_register")
        .and_then(Value::as_array)
        .cloned()
        .unwrap_or_default();
    query_register.push(json!({
        "query_id": "history.by_w044_obligation",
        "query_kind": "join_service_rows_to_w044_release_grade_blocker_map",
        "result_source": W044_RESIDUAL_MAP,
        "deterministic": true
    }));
    query_register.push(json!({
        "query_id": "history.by_w044_stage2_service_dependency",
        "query_kind": "join_history_rows_to_w044_stage2_service_blockers",
        "result_source": W044_STAGE2_BLOCKERS,
        "deterministic": true
    }));
    query_register.push(json!({
        "query_id": "history.by_w044_proof_model_service_dependencies",
        "query_kind": "join_history_rows_to_w044_rust_and_lean_tla_proof_model_blockers",
        "result_source": W044_LEAN_TLA_BLOCKERS,
        "deterministic": true
    }));
    query_register.push(json!({
        "query_id": "history.by_w044_pack_and_retained_witness_gate",
        "query_kind": "join_history_rows_to_w043_pack_and_w044_retained_witness_dependencies",
        "result_source": W043_PACK_DECISION,
        "deterministic": true
    }));

    let mut replay_correlation_index = w043_retained
        .get("replay_correlation_index")
        .and_then(Value::as_array)
        .cloned()
        .unwrap_or_default();
    replay_correlation_index.push(json!({
        "correlation_id": "corr.w044_stage2_service_dependency",
        "source_artifacts": [W044_STAGE2_SUMMARY, W044_STAGE2_BLOCKERS],
        "w044_obligations": ["W044-OBL-021", "W044-OBL-022", "W044-OBL-023"],
        "replay_role": "stage2_analyzer_service_dependency"
    }));
    replay_correlation_index.push(json!({
        "correlation_id": "corr.w044_retained_witness_pack_gate",
        "source_artifacts": [W044_STAGE2_BLOCKERS, W043_PACK_DECISION],
        "w044_obligations": ["W044-OBL-024", "W044-OBL-025"],
        "replay_role": "retained_witness_lifecycle_slo_and_pack_governance_gate"
    }));
    replay_correlation_index.push(json!({
        "correlation_id": "corr.w044_proof_model_service_gate",
        "source_artifacts": [W044_RUST_SUMMARY, W044_LEAN_TLA_SUMMARY, W044_STAGE2_SUMMARY],
        "w044_obligations": ["W044-OBL-014", "W044-OBL-017", "W044-OBL-021"],
        "replay_role": "proof_model_rows_as_service_readiness_inputs_only"
    }));
    replay_correlation_index.push(json!({
        "correlation_id": "corr.w044_w073_formatting_guard",
        "source_artifacts": [W044_OXFML_INBOUND_INTAKE],
        "w044_obligations": ["W044-OBL-033", "W044-OBL-037"],
        "replay_role": "observable_formatting_watch"
    }));

    json!({
        "schema_version": W044_RETAINED_HISTORY_SERVICE_SCHEMA_V1,
        "run_id": run_id,
        "artifact_root": relative_artifact_root,
        "history_kind": "w044_retained_history_query_contract_with_retained_witness_slo_stage2_proof_model_and_formatting_watch",
        "file_backed_retained_history_store_present": true,
        "retained_history_query_api_contract_present": true,
        "retained_history_query_register_present": true,
        "replay_correlation_index_present": true,
        ...
        "retention_slo_enforced": false,
        "stage2_policy_promoted": false,
        "stage2_service_dependency_blocker_present": row_with_field_exists(
            w044_stage2_blockers,
            "row_id",
            "w044_stage2_operated_cross_engine_service_dependency_blocker"
        ),
        "source_history_row_count": number_at(w043_retained, "store_record_count"),
        "store_record_count": rows.len(),
        "query_register_row_count": query_register.len(),
        "replay_correlation_row_count": replay_correlation_index.len(),
        "history_lifecycle_state": "file_backed_query_contract_extended_without_operated_retained_history_service",
...
fn w044_retained_witness_lifecycle(
    run_id: &str,
    w043_witness: &Value,
    w044_stage2_decision: &Value,
) -> Value {
    let mut rows = w043_witness
        .get("rows")
        .and_then(Value::as_array)
        .cloned()
        .unwrap_or_default();
    rows.push(json!({
        "row_id": "witness.w044_retention_slo_service_gate",
        "source_artifact": W044_RESIDUAL_MAP,
        "lifecycle_state": "retention_slo_policy_declared_not_enforced",
        "retention_slo_policy_declared": true,
        "retention_slo_enforced": false,
        "pack_eligible": false,
    ...
    rows.push(json!({
        "row_id": "witness.w044_stage2_retained_witness_pack_gate",
        "source_artifact": W044_STAGE2_DECISION,
        "lifecycle_state": "stage2_retained_witness_dependency_retained",
        "stage2_retained_witness_lifecycle_promoted": bool_at(w044_stage2_decision, "retained_witness_lifecycle_promoted"),
        "pack_grade_replay_promoted": bool_at(w044_stage2_decision, "pack_grade_replay_promoted"),
        "pack_eligible": false,
        "promotion_consequence": "pack-grade replay and C5 remain unpromoted"
    }));
    rows.push(json!({
        "row_id": "witness.w044_pack_grade_replay_governance_gate",
        "source_artifact": W044_STAGE2_DECISION,
        "lifecycle_state": "pack_governance_dependency_retained",
        "pack_grade_replay_governance_promoted": bool_at(w044_stage2_decision, "pack_grade_replay_governance_promoted"),
        "pack_eligible": false,
        "promotion_consequence": "pack-grade replay governance service remains unpromoted"
    }));
    ...
    json!({
        "schema_version": W044_RETAINED_WITNESS_SCHEMA_V1,
        "run_id": run_id,
        "retained_witness_lifecycle_register_present": true,
        "retained_witness_lifecycle_service_promoted": false,
        "retention_slo_policy_declared": true,
...
fn w044_alert_dispatch_service(
    run_id: &str,
    w043_alerts: &Value,
    w043_promotion: &Value,
    w044_stage2_decision: &Value,
    ...
    let mut rows = w043_alerts
        .get("rows")
        .and_then(Value::as_array)
        .cloned()
        .unwrap_or_default();
    rows.push(json!({
        "rule_id": "quarantine.w044_unsupported_operated_service_claim",
        "action": "quarantine_run_and_block_service_promotion",
        "trigger": "any W043/W044 operated service, retained-history service, retained-witness service, external dispatcher, Stage 2 service, pack, C5, or release-grade promotion flag appears without operated service artifacts",
        "owner": "calc-b1t.6; calc-b1t.10; calc-b1t.11",
        "triggered": bool_at(w043_promotion, "operated_continuous_assurance_service_promoted")
            || bool_at(w043_promotion, "retained_history_service_promoted")
            || bool_at(w043_promotion, "retained_witness_lifecycle_service_promoted")
            || bool_at(w043_promotion, "retention_slo_enforcement_promoted")
            || bool_at(w043_promotion, "external_alert_dispatcher_promoted")
            || bool_at(w044_stage2_decision, "operated_cross_engine_stage2_service_promoted")
            || bool_at(w043_pack_decision, "capability_promoted"),
        "decision": "clean",
        "evidence": {
            "operated_continuous_assurance_service_promoted": bool_at(w043_promotion, "operated_continuous_assurance_service_promoted"),
            "retained_history_service_promoted": bool_at(w043_promotion, "retained_history_service_promoted"),
            "retained_witness_lifecycle_service_promoted": bool_at(w043_promotion, "retained_witness_lifecycle_service_promoted"),
            "retention_slo_enforcement_promoted": bool_at(w043_promotion, "retention_slo_enforcement_promoted"),
            "external_alert_dispatcher_promoted": bool_at(w043_promotion, "external_alert_dispatcher_promoted"),
            "operated_cross_engine_stage2_service_promoted": bool_at(w044_stage2_decision, "operated_cross_engine_stage2_service_promoted"),
            "pack_capability_promoted": bool_at(w043_pack_decision, "capability_promoted")
        }
    }));
    rows.push(json!({
        "rule_id": "quarantine.w044_missing_retained_history_or_witness_contract",
        "action": "quarantine_run_and_block_pack_reassessment",
        "trigger": "retained-history query API contract, replay-correlation index, or retained-witness register is absent",
        "owner": "calc-b1t.6; calc-b1t.10",
        "triggered": !bool_at(retained_history, "retained_history_query_api_contract_present")
            || !bool_at(retained_history, "replay_correlation_index_present")
            || !bool_at(retained_witness_register, "retained_witness_lifecycle_register_present"),
        "decision": "clean",
    ...
    rows.push(json!({
        "rule_id": "quarantine.w044_stage2_operated_service_claim_without_service",
        "action": "quarantine_run_and_block_stage2_promotion",
        "trigger": "W044 Stage 2 claims operated cross-engine service or policy promotion while service readiness remains file-backed",
        "owner": "calc-b1t.6; calc-b1t.5; calc-b1t.10",
        "triggered": bool_at(w044_stage2_decision, "operated_cross_engine_stage2_service_promoted")
            || bool_at(w044_stage2_decision, "stage2_policy_promoted"),
        "decision": "clean",
        "evidence": {
            "operated_cross_engine_stage2_service_promoted": bool_at(w044_stage2_decision, "operated_cross_engine_stage2_service_promoted"),
            "stage2_policy_promoted": bool_at(w044_stage2_decision, "stage2_policy_promoted")
        }
    }));
    rows.push(json!({
        "rule_id": "alert.w044_retention_slo_not_enforced",
        "action": "record_retention_slo_blocker_without_dispatch",
        "trigger": "retention SLO policy is declared but not enforced by an operated service",
        "owner": "calc-b1t.6; calc-b1t.10",
        "triggered": false,
    ...
    rows.push(json!({
        "rule_id": "alert.w044_w073_typed_formatting_guard_retained",
        "action": "record_w073_guard_without_handoff",
        "trigger": "W044 service packet carries current OxFml W073 typed-only conditional-formatting input guard",
        "owner": "calc-b1t.6; calc-b1t.8",
        "triggered": false,
        "decision": "clean",
        "evidence": {
            "typed_rule_only_family_count": array_len(&w044_oxfml_inbound_intake["w073_formatting"]["typed_rule_only_families"]),
            "threshold_fallback_allowed_for_typed_families": bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "threshold_fallback_allowed_for_typed_families"),
            "downstream_typed_rule_request_construction_required": bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "downstream_typed_rule_request_construction_required"),
            "downstream_uptake_verified_by_oxcalc": bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "downstream_uptake_verified_by_oxcalc")
        }
    }));
    rows.push(json!({
        "rule_id": "quarantine.w044_w073_old_string_fallback_claim",
        "action": "quarantine_run_and_open_oxfml_seam_handoff",
        "trigger": "W044 evidence claims W072 bounded threshold strings still define aggregate or visualization metadata for W073 families",
        "owner": "calc-b1t.6; calc-b1t.8",
        "triggered": bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "threshold_fallback_allowed_for_typed_families"),
        "decision": "clean",
        "evidence": {
            "threshold_fallback_allowed_for_typed_families": bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "threshold_fallback_allowed_for_typed_families"),
            "old_bounded_string_non_interpretation_evidence_reviewed": bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "old_bounded_string_non_interpretation_evidence_reviewed")
        }
    }));
    ...
    json!({
        "schema_version": W044_ALERT_DISPATCH_SCHEMA_V1,
        "run_id": run_id,
        "policy_source": W043_ALERT_DISPATCH_SERVICE,
        "policy_state": "w044_local_alert_dispatch_service_contract_evaluated_without_external_dispatcher_promotion",
        "evaluated_rule_count": rows.len(),
        "quarantine_decision_count": quarantine_decision_count,
        "alert_decision_count": alert_decision_count,
        "clean_rule_count": rows.len() - quarantine_decision_count - alert_decision_count,
...
fn w044_cross_engine_service(
    ...
    json!({
        "schema_version": W044_CROSS_ENGINE_SERVICE_SCHEMA_V1,
        "run_id": run_id,
        "file_backed_cross_engine_substrate_present": bool_at(w043_cross_engine, "file_backed_cross_engine_substrate_present"),
        "w043_stage2_service_dependency_blocker_present": bool_at(w043_cross_engine, "w043_stage2_service_dependency_blocker_present"),
        "w044_stage2_policy_row_count": number_at(w044_stage2_summary, "policy_row_count"),
        "w044_stage2_service_dependency_blocker_present": row_with_field_exists(
            w044_stage2_blockers,
            "row_id",
            "w044_stage2_operated_cross_engine_service_dependency_blocker"
        ),
        ...
        "operated_cross_engine_differential_service_promoted": false,
        "service_endpoint_present": false,
        "service_state": "file_backed_cross_engine_substrate_and_w044_stage2_dependency_bound_without_operated_service",
        "blocked_service_claims": [
            "recurring_cross_engine_diff_scheduler",
            "cross_engine_service_endpoint",
            "operated_mismatch_quarantine_dispatcher",
...
fn w044_service_readiness(
    ...
    let criteria = vec![
        criterion(
            "readiness.w044_service_envelope_present",
            "satisfied",
            "W044 emits a file-backed operated-assurance service envelope through the checked runner",
        ),
        criterion(
            "readiness.w044_source_evidence_index_bound",
            "satisfied",
            "W044 source index binds W044 residual obligations, W043 service evidence, W044 proof/model evidence, W044 Stage 2 blockers, W043 pack blockers, and W073 formatting intake",
        ),
        criterion(
            "readiness.w044_run_queue_manifest_declared",
            "satisfied_boundary",
            "service-readable run queue manifest is declared in the envelope, but not operated as a scheduler",
        ),
        criterion(
            "readiness.w044_retained_history_query_contract_present",
            "satisfied_boundary",
            "deterministic retained-history query API contract is emitted with store and query rows",
        ),
        criterion(
            "readiness.w044_replay_correlation_index_present",
            "satisfied",
            "replay-correlation rows are emitted for W044 Stage 2 service dependencies, proof/model inputs, retained-witness pack governance, and W073 guard evidence",
        ),
        criterion(
            "readiness.w044_retained_witness_lifecycle_register_present",
            "satisfied_boundary",
            "retained-witness lifecycle rows are registered without pack eligibility promotion",
        ),
        criterion(
            "readiness.w044_retention_slo_policy_declared",
            "satisfied_boundary",
            "retention SLO policy is declared for retained-history and retained-witness lifecycle evidence",
        ),
        criterion(
            "readiness.w044_alert_dispatch_contract_evaluated",
            "satisfied",
            "local alert/quarantine dispatch contract is evaluated against service, retained-history, retained-witness, Stage 2, pack, proof/model, and W073 inputs",
        ),
        criterion(
            "readiness.w044_no_quarantine_decisions",
            "satisfied",
            "W044 local dispatch contract and source evidence produce no quarantine decisions",
        ),
        criterion(
            "readiness.w044_cross_engine_substrate_bound",
            "satisfied_boundary",
            "W044 binds file-backed cross-engine substrate and Stage 2 service dependency without service promotion",
        ),
        criterion(
            "readiness.w044_optimized_core_service_input_bound",
            "satisfied",
            "W044 mixed dynamic add/remove/reclassify evidence is bound as service-readiness input only",
        ),
        criterion(
            "readiness.w044_rust_refinement_bridge_bound",
            "satisfied",
            "W044 Rust mixed dynamic and no-publication refinement rows are bound as service-readiness input only",
        ),
        criterion(
            "readiness.w044_lean_tla_model_bound_bridge_bound",
            "satisfied_boundary",
            "W044 Lean/TLA bounded model rows are bound without promoting fairness or unbounded coverage",
        ),
        criterion(
            "readiness.w044_stage2_service_dependency_classified",
            "satisfied",
            "W044 Stage 2 analyzer retains operated cross-engine service as an exact dependency",
        ),
        criterion(
            "readiness.w044_retained_witness_pack_dependency_classified",
            "satisfied",
            "W044 Stage 2 analyzer retains retained-witness lifecycle and retention SLO as exact pack-grade replay dependencies",
        ),
        criterion(
            "readiness.w044_pack_governance_dependency_classified",
            "satisfied",
            "W044 Stage 2 and W043 pack decision retain pack-grade replay governance as a no-promotion dependency",
        ),
        criterion(
            "readiness.w044_w073_typed_formatting_guard_retained",
            "satisfied",
            "W044 carries OxFml W073 typed_rule-only aggregate/visualization formatting guard and old-string non-interpretation evidence",
        ),
        criterion(
            "readiness.w044_downstream_w073_request_construction_unverified",
            "satisfied_boundary",
            "downstream typed-rule request construction remains required but unverified by OxCalc and is routed to calc-b1t.8",
        ),
        criterion(
            "readiness.w044_no_proxy_service_promotion_guard",
            "satisfied",
            "file-backed and local-only artifacts are not counted as operated service, pack, Stage 2, C5, or release-grade promotions",
        ),
        criterion(
    ...
    json!({
        "schema_version": W044_SERVICE_READINESS_SCHEMA_V1,
        "run_id": run_id,
        "artifact_root": relative_artifact_root,
        "readiness_state": "w044_service_packet_validated_without_operated_service_promotion",
        "criteria_count": criteria.len(),
        "satisfied_criteria_count": criteria.len() - blocked_criteria_count,
        "blocked_criteria_count": blocked_criteria_count,
        "service_envelope_row_count": number_at(service_envelope, "row_count"),
        ...
        "file_backed_cross_engine_substrate_present": bool_at(cross_engine_service, "file_backed_cross_engine_substrate_present"),
        "stage2_policy_promoted": bool_at(w044_stage2_decision, "stage2_policy_promoted"),
        "w073_typed_rule_only_formatting_guard_carried": array_len(&w044_oxfml_inbound_intake["w073_formatting"]["typed_rule_only_families"]) == 7
            && !bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "threshold_fallback_allowed_for_typed_families")
            && bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "old_bounded_string_non_interpretation_evidence_reviewed"),
        "w073_downstream_typed_rule_request_construction_required": bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "downstream_typed_rule_request_construction_required"),
        "w073_downstream_typed_rule_request_construction_verified": bool_at(&w044_oxfml_inbound_intake["w073_formatting"], "downstream_uptake_verified_by_oxcalc"),
...
fn w044_exact_service_blockers() -> Vec<Value> {
    vec![
        json!({
            "blocker_id": "service.operated_scheduler_service_endpoint_absent",
            "owner": "calc-b1t.6; calc-b1t.10",
            "status_after_run": "exact_remaining_blocker",
            "reason": "W044 emits a file-backed service envelope and run queue manifest, but no recurring scheduler, daemon, service endpoint, or operated run queue.",
            "promotion_consequence": "operated continuous assurance service remains unpromoted"
        }),
        json!({
            "blocker_id": "service.retained_history_service_endpoint_absent",
            "owner": "calc-b1t.6; calc-b1t.10",
            "status_after_run": "exact_remaining_blocker",
            "reason": "W044 emits a retained-history query API contract and replay-correlation index, but no operated retained-history service endpoint or retention lifecycle service.",
            "promotion_consequence": "retained-history service and pack-grade replay governance remain unpromoted"
        }),
        json!({
            "blocker_id": "service.retained_witness_lifecycle_service_slo_absent",
            "owner": "calc-b1t.6; calc-b1t.10",
            "status_after_run": "exact_remaining_blocker",
            "reason": "W044 carries retained-witness lifecycle rows and declares a retention SLO policy, but no lifecycle service or SLO enforcement exists.",
            "promotion_consequence": "retained-witness lifecycle service, retention SLO enforcement, pack-grade replay, C5, and release-grade verification remain unpromoted"
        }),
        json!({
            "blocker_id": "service.external_alert_dispatcher_absent",
            "owner": "calc-b1t.6; calc-b1t.7; calc-b1t.10",
            "status_after_run": "exact_remaining_blocker",
            "reason": "W044 evaluates alert/quarantine dispatch rules locally and records an external dispatcher contract, but no external dispatcher or quarantine service is operated.",
            "promotion_consequence": "alert/quarantine dispatcher and mismatch quarantine service claims remain unpromoted"
        }),
        json!({
            "blocker_id": "service.operated_cross_engine_differential_absent",
            "owner": "calc-b1t.6; calc-b1t.7",
            "status_after_run": "exact_remaining_blocker",
            "reason": "cross-engine evidence remains file-backed and does not run as an operated differential service.",
            "promotion_consequence": "operated cross-engine differential service, independent diversity, mismatch quarantine, and Stage 2 service dependencies remain blocked"
        }),
        json!({
            ...
            "owner": "calc-b1t.6; calc-b1t.10",
            "status_after_run": "exact_remaining_blocker",
            "reason": "W044 retained-history and retained-witness rows are deterministic local artifacts, but no pack-grade replay governance service binds them into a program-grade retained-witness lifecycle.",
            "promotion_consequence": "pack-grade replay, C5, and release-grade verification remain unpromoted"
        }),
    ]
}
...
fn w045_source_rows(
    ...
    w045_residual_map: &Value,
    w045_promotion_contract_map: &Value,
    w045_oxfml_inbound_intake: &Value,
    w044_summary: &Value,
    w044_validation: &Value,
    w044_envelope: &Value,
    w044_retained: &Value,
    w044_witness: &Value,
    w044_alerts: &Value,
    w044_cross_engine: &Value,
    w044_readiness: &Value,
    w044_blockers: &Value,
    w044_promotion: &Value,
    w045_optimized_summary: &Value,
    w045_optimized_validation: &Value,
    w045_dynamic_transition: &Value,
    w045_optimized_blockers: &Value,
    w045_match_guard: &Value,
    w045_rust_summary: &Value,
    w045_rust_validation: &Value,
    w045_rust_refinement: &Value,
    w045_rust_blockers: &Value,
    w045_lean_tla_summary: &Value,
    w045_lean_tla_validation: &Value,
    w045_tla_model_bound: &Value,
    w045_lean_tla_blockers: &Value,
    w045_stage2_summary: &Value,
    w045_stage2_validation: &Value,
    w045_stage2_decision: &Value,
    w045_stage2_service_gate: &Value,
    w045_stage2_blockers: &Value,
    w044_pack_summary: &Value,
    w044_pack_decision: &Value,
) -> Vec<Value> {
    vec![
        json!({
            "row_id": "source.w045_residual_successor_obligation_map",
            "artifact": W045_RESIDUAL_MAP,
            "valid": text_at(w045_residual_summary, "status") == "residual_successor_obligation_current_oxfml_intake_map_validated"
                && number_at(w045_residual_summary, "successor_obligation_count") == 36
                && number_at(w045_residual_summary, "promotion_contract_count") == 18
                && number_at(w045_residual_map, "source_residual_lane_count") == 22
                && number_at(w045_residual_map, "successor_obligation_count") == 36,
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": false,
            "semantic_state": "w045_operated_service_obligations_bound"
        }),
        json!({
            "row_id": "source.w045_oxfml_w073_inbound_update",
            "artifact": W045_OXFML_INBOUND_INTAKE,
            "valid": array_len(&w045_oxfml_inbound_intake["w073_formatting"]["typed_rule_only_families"]) == 7
                && !bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "threshold_fallback_allowed_for_typed_families")
                && bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "old_bounded_string_non_interpretation_evidence_reviewed")
                && bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "downstream_typed_rule_request_construction_required")
                && !bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "downstream_uptake_verified_by_oxcalc")
                && !bool_at(w045_oxfml_inbound_intake, "handoff_required"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": false,
            "semantic_state": "current_oxfml_w073_typed_only_update_carried_as_w045_watch_row"
        }),
        json!({
            "row_id": "source.w044_operated_assurance_predecessor_summary",
            "artifact": W044_OPERATED_ASSURANCE_SUMMARY,
            "valid": text_at(w044_validation, "status") == "w044_operated_assurance_retained_history_witness_slo_alert_service_valid"
                && number_at(w044_summary, "source_evidence_row_count") == 17
                && number_at(w044_summary, "exact_service_blocker_count") == 6
                && number_at(w044_summary, "failed_row_count") == 0,
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w044_summary, "failed_row_count"),
            "promoted_unsupported_service": bool_at(w044_promotion, "operated_continuous_assurance_service_promoted")
                || bool_at(w044_promotion, "retained_history_service_promoted")
                || bool_at(w044_promotion, "retained_witness_lifecycle_service_promoted")
                || bool_at(w044_promotion, "retention_slo_enforcement_promoted")
                || bool_at(w044_promotion, "external_alert_dispatcher_promoted")
                || bool_at(w044_promotion, "operated_cross_engine_differential_service_promoted"),
            "semantic_state": "w044_service_packet_bound_without_service_promotion"
        }),
        json!({
            "row_id": "source.w044_service_envelope",
            "artifact": W044_OPERATED_SERVICE_ENVELOPE,
            "valid": bool_at(w044_envelope, "file_backed_service_envelope_present")
                && bool_at(w044_envelope, "service_run_queue_manifest_present")
                && !bool_at(w044_envelope, "operated_run_queue_present")
                && !bool_at(w044_envelope, "service_endpoint_present"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w044_envelope, "operated_run_queue_present")
                || bool_at(w044_envelope, "service_endpoint_present"),
            "semantic_state": "w044_file_backed_service_envelope_available_for_w045_harness"
        }),
        json!({
            "row_id": "source.w044_retained_history_query_contract",
            "artifact": W044_RETAINED_HISTORY_SERVICE_QUERY,
            "valid": number_at(w044_retained, "store_record_count") == 40
                && number_at(w044_retained, "query_register_row_count") == 17
                && number_at(w044_retained, "replay_correlation_row_count") == 15
                && bool_at(w044_retained, "retained_history_query_api_contract_present")
                && bool_at(w044_retained, "replay_correlation_index_present")
                && !bool_at(w044_retained, "retained_history_service_operated")
                && !bool_at(w044_retained, "retention_slo_enforced"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w044_retained, "retained_history_service_operated")
                || bool_at(w044_retained, "retained_history_service_promoted"),
            "semantic_state": "w044_retained_history_query_contract_bound_for_w045"
        }),
        json!({
            "row_id": "source.w044_retained_witness_lifecycle",
            "artifact": W044_RETAINED_WITNESS_LIFECYCLE,
            "valid": bool_at(w044_witness, "retained_witness_lifecycle_register_present")
                && number_at(w044_witness, "witness_lifecycle_row_count") == 11
                && number_at(w044_witness, "pack_eligible_witness_count") == 0
                && !bool_at(w044_witness, "retained_witness_lifecycle_service_promoted")
                && !bool_at(w044_witness, "retention_slo_enforced"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w044_witness, "retained_witness_lifecycle_service_promoted")
                || number_at(w044_witness, "pack_eligible_witness_count") > 0,
            "semantic_state": "w044_retained_witness_lifecycle_bound_without_pack_eligibility"
        }),
        json!({
            "row_id": "source.w044_alert_dispatch_contract",
            "artifact": W044_ALERT_DISPATCH_SERVICE,
            "valid": number_at(w044_alerts, "evaluated_rule_count") == 35
                && number_at(w044_alerts, "quarantine_decision_count") == 0
                && number_at(w044_alerts, "alert_decision_count") == 0
                && bool_at(w044_alerts, "local_alert_dispatcher_evaluated")
                && bool_at(w044_alerts, "external_alert_dispatcher_contract_present"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w044_alerts, "quarantine_decision_count"),
            "promoted_unsupported_service": bool_at(w044_alerts, "external_alert_dispatcher_promoted")
                || bool_at(w044_alerts, "quarantine_service_promoted"),
            "semantic_state": "w044_local_alert_dispatch_contract_clean_for_w045"
        }),
        json!({
            "row_id": "source.w044_cross_engine_service_blocker",
            "artifact": W044_CROSS_ENGINE_SERVICE_REGISTER,
            "valid": bool_at(w044_cross_engine, "file_backed_cross_engine_substrate_present")
                && bool_at(w044_cross_engine, "w044_stage2_service_dependency_blocker_present")
                && !bool_at(w044_cross_engine, "operated_cross_engine_differential_service_present")
                && !bool_at(w044_cross_engine, "service_endpoint_present"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w044_cross_engine, "operated_cross_engine_differential_service_promoted"),
            "semantic_state": "w044_cross_engine_file_backed_substrate_bound"
        }),
        json!({
            "row_id": "source.w044_service_readiness_blockers",
            "artifact": W044_SERVICE_READINESS_REGISTER,
            "valid": number_at(w044_readiness, "blocked_criteria_count") == 6
                && number_at(w044_blockers, "exact_service_blocker_count") == 6
                && bool_at(w044_readiness, "w073_typed_rule_only_formatting_guard_carried"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w044_readiness, "operated_continuous_assurance_service_promoted")
                || bool_at(w044_readiness, "retained_history_service_promoted")
                || bool_at(w044_readiness, "retained_witness_lifecycle_service_promoted")
                || bool_at(w044_readiness, "external_alert_dispatcher_promoted")
                || bool_at(w044_readiness, "cross_engine_differential_service_promoted"),
            "semantic_state": "w044_exact_service_blockers_bound_for_w045"
        }),
        json!({
            "row_id": "source.w045_optimized_core_dynamic_service_input",
            "artifact": W045_DYNAMIC_TRANSITION_COVERAGE,
            "valid": text_at(w045_optimized_validation, "status") == "implementation_conformance_w045_optimized_core_counterpart_callable_metadata_valid"
                && number_at(w045_optimized_summary, "failed_row_count") == 0
                && number_at(w045_optimized_summary, "w045_exact_remaining_blocker_count") == 5
                && number_at(w045_dynamic_transition, "direct_evidence_bound_count") == 2
                && number_at(w045_dynamic_transition, "exact_remaining_blocker_count") == 2
                && number_at(w045_optimized_blockers, "exact_remaining_blocker_count") == 5,
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w045_optimized_summary, "failed_row_count"),
            "promoted_unsupported_service": number_at(w045_optimized_summary, "w045_match_promoted_count") > 0,
            "semantic_state": "w045_dynamic_transition_coverage_bound_as_service_input_without_optimized_core_promotion"
        }),
        json!({
            "row_id": "source.w045_rust_refinement_service_bridge",
            "artifact": W045_RUST_REFINEMENT,
            "valid": text_at(w045_rust_validation, "status") == "formal_assurance_w045_rust_totality_refinement_valid"
                && number_at(w045_rust_summary, "failed_row_count") == 0
                && number_at(w045_rust_summary, "exact_remaining_blocker_count") == 7
                && number_at(w045_rust_refinement, "refinement_row_count") == 9
                && number_at(w045_rust_blockers, "exact_remaining_blocker_count") == 7,
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w045_rust_summary, "failed_row_count"),
            "promoted_unsupported_service": bool_at(&w045_rust_summary["promotion_claims"], "rust_engine_totality_promoted")
                || bool_at(&w045_rust_summary["promotion_claims"], "rust_refinement_promoted")
                || bool_at(&w045_rust_summary["promotion_claims"], "panic_free_core_domain_promoted"),
            "semantic_state": "w045_rust_refinement_bridge_bound_without_totality_promotion"
        }),
        json!({
            "row_id": "source.w045_lean_tla_model_bound_service_bridge",
            "artifact": W045_TLA_MODEL_BOUND,
            "valid": text_at(w045_lean_tla_validation, "status") == "formal_assurance_w045_lean_tla_fairness_totality_valid"
                && number_at(w045_lean_tla_summary, "failed_row_count") == 0
                && number_at(w045_lean_tla_summary, "exact_remaining_blocker_count") == 6
                && number_at(w045_tla_model_bound, "bounded_model_row_count") == 4
                && number_at(w045_lean_tla_blockers, "exact_remaining_blocker_count") == 6,
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w045_lean_tla_summary, "failed_row_count"),
            "promoted_unsupported_service": bool_at(&w045_lean_tla_summary["promotion_claims"], "full_tla_verification_promoted")
                || bool_at(&w045_lean_tla_summary["promotion_claims"], "scheduler_fairness_promoted")
                || bool_at(&w045_lean_tla_summary["promotion_claims"], "unbounded_model_coverage_promoted"),
            "semantic_state": "w045_lean_tla_bounded_model_bound_without_unbounded_scheduler_promotion"
        }),
        json!({
            "row_id": "source.w045_stage2_service_gate",
            "artifact": W045_STAGE2_SUMMARY,
            "valid": text_at(w045_stage2_validation, "status") == "w045_stage2_pack_service_equivalence_valid"
                && number_at(w045_stage2_summary, "failed_row_count") == 0
                && number_at(w045_stage2_summary, "exact_remaining_blocker_count") == 10
                && bool_at(w045_stage2_summary, "service_gate_classification_evidenced")
                && row_with_field_exists(
                    w045_stage2_blockers,
                    "row_id",
                    "w045_stage2_operated_cross_engine_service_dependency_blocker"
                ),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": number_at(w045_stage2_summary, "failed_row_count"),
            "promoted_unsupported_service": bool_at(w045_stage2_decision, "operated_cross_engine_stage2_service_promoted")
                || bool_at(w045_stage2_decision, "stage2_policy_promoted")
                || bool_at(w045_stage2_decision, "service_gate_promoted"),
            "semantic_state": "w045_stage2_service_gate_bound"
        }),
        json!({
            "row_id": "source.w045_stage2_service_gate_register",
            "artifact": W045_STAGE2_SERVICE_GATE,
            "valid": number_at(w045_stage2_service_gate, "row_count") == 10
                && number_at(w045_stage2_service_gate, "exact_remaining_blocker_count") == 4
                && bool_at(w045_stage2_service_gate, "service_gate_classification_evidenced")
                && !bool_at(w045_stage2_service_gate, "service_gate_promoted"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": failed_rows_in_register(w045_stage2_service_gate),
            "promoted_unsupported_service": bool_at(w045_stage2_service_gate, "service_gate_promoted"),
            "semantic_state": "w045_stage2_service_gate_register_bound_without_service_promotion"
        }),
        json!({
            "row_id": "source.w045_stage2_exact_blockers",
            "artifact": W045_STAGE2_BLOCKERS,
            "valid": number_at(w045_stage2_blockers, "exact_remaining_blocker_count") == 10
                && row_with_field_exists(
                    w045_stage2_blockers,
                    "row_id",
                    "w045_stage2_retained_witness_lifecycle_pack_dependency_blocker"
                )
                && row_with_field_exists(
                    w045_stage2_blockers,
                    "row_id",
                    "w045_stage2_pack_grade_replay_governance_blocker"
                ),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": failed_rows_in_register(w045_stage2_blockers),
            "promoted_unsupported_service": bool_at(w045_stage2_decision, "retained_witness_lifecycle_promoted")
                || bool_at(w045_stage2_decision, "pack_grade_replay_governance_promoted")
                || bool_at(w045_stage2_decision, "pack_grade_replay_promoted"),
            "semantic_state": "w045_stage2_service_retained_witness_and_pack_blockers_retained"
        }),
        json!({
            "row_id": "source.w045_no_proxy_promotion_guard",
            "artifact": W045_MATCH_PROMOTION_GUARD,
            "valid": text_at(w045_match_guard, "guard_status") == "w045_declared_gap_promotion_guard_holds"
                && number_at(w045_match_guard, "promoted_match_count") == 0
                && !bool_at(w045_stage2_decision, "stage2_policy_promoted")
                && !bool_at(w045_stage2_decision, "pack_grade_replay_promoted")
                && !bool_at(w044_promotion, "operated_continuous_assurance_service_promoted"),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w044_promotion, "operated_continuous_assurance_service_promoted")
                || bool_at(w045_stage2_decision, "stage2_policy_promoted")
                || bool_at(w045_stage2_decision, "pack_grade_replay_promoted"),
            "semantic_state": "w045_service_no_proxy_promotion_guard_clean"
        }),
        json!({
            "row_id": "source.w045_service_obligations",
            "artifact": W045_RESIDUAL_MAP,
            "valid": row_with_field_exists(
                    w045_residual_map,
                    "source_lane",
                    "w044_residual.operated_assurance_service"
                )
                && row_with_field_exists(
                    w045_residual_map,
                    "source_lane",
                    "w044_residual.retained_history_and_witness_lifecycle"
                )
                && row_with_field_exists(
                    w045_residual_map,
                    "source_lane",
                    "w044_residual.external_alert_dispatcher"
                ),
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": false,
            "semantic_state": "w045_operated_assurance_retained_history_retained_witness_and_alert_obligations_bound"
        }),
        json!({
            "row_id": "source.w045_promotion_contracts",
            "artifact": W045_PROMOTION_CONTRACT_MAP,
            "valid": number_at(w045_promotion_contract_map, "promotion_contract_count") == 18,
            "missing_artifact_count": 0,
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": false,
            "semantic_state": "w045_promotion_contracts_bound_as_no_proxy_service_gates"
        }),
        json!({
            "row_id": "source.w044_pack_c5_service_blockers",
            "artifact": W044_PACK_DECISION,
            "valid": text_at(w044_pack_summary, "decision_status") == "capability_not_promoted"
                && text_at(w044_pack_decision, "decision_status") == "capability_not_promoted"
                && !bool_at(w044_pack_decision, "capability_promoted")
                && number_at(w044_pack_decision, "missing_artifact_count") == 0
                && array_contains_string(
                    &w044_pack_decision["no_promotion_reason_ids"],
                    "pack.grade.w044_retained_history_service_absent"
                )
                && array_contains_string(
                    &w044_pack_decision["no_promotion_reason_ids"],
                    "pack.grade.w044_retained_witness_lifecycle_service_absent"
                ),
            "missing_artifact_count": number_at(w044_pack_decision, "missing_artifact_count"),
            "unexpected_mismatch_count": 0,
            "failed_row_count": 0,
            "promoted_unsupported_service": bool_at(w044_pack_decision, "capability_promoted"),
            "semantic_state": "w044_pack_c5_retained_history_retained_witness_and_service_blockers_bound"
        }),
        json!({
            "row_id": "source.w045_retained_lifecycle_no_promotion_guard",
            "artifact": W045_STAGE2_DECISION,
            "valid": !bool_at(w045_stage2_decision, "retained_witness_lifecycle_promoted")
                && !bool_at(w045_stage2_decision, "pack_grade_replay_governance_promoted")
                && !bool_at(w045_stage2_decision, "pack_grade_replay_promoted")
                && !bool_at(w044_promotion, "retained_history_service_promoted")
                && !bool_at(w044_promotion, "retained_witness_lifecycle_service_promoted")
            ...
            "promoted_unsupported_service": bool_at(w045_stage2_decision, "retained_witness_lifecycle_promoted")
                ...
                || bool_at(w044_promotion, "retained_witness_lifecycle_service_promoted")
                || bool_at(w044_promotion, "retention_slo_enforcement_promoted"),
            "semantic_state": "retained_history_witness_slo_and_pack_lifecycle_no_promotion_guard_clean"
        }),
    ]
}

fn w045_operated_service_envelope(
    run_id: &str,
    relative_artifact_root: &str,
    source_evidence_row_count: usize,
) -> Value {
    let rows = vec![
        json!({
            ...
            "state": "satisfied",
            "runner_command": format!("cargo run -p oxcalc-tracecalc-cli -- operated-assurance {run_id}"),
            "evidence_or_blocker": "W045 operated-assurance packet is emitted by the checked CLI runner"
        }),
        json!({
            "row_id": "service.artifact_root",
            "state": "satisfied",
            "artifact_root": relative_artifact_root,
            "evidence_or_blocker": "runner writes source index, service envelope, local harness register, retained-history query, retained-witness lifecycle, alert dispatch, cross-engine service, readiness, blockers, decision, and validation artifacts"
        }),
        json!({
            "row_id": "service.source_ingestion",
            "state": "satisfied",
            "source_evidence_row_count": source_evidence_row_count,
            "evidence_or_blocker": "runner binds W045 residual obligations, W044 service packet, W045 proof/model and Stage 2 artifacts, W044 pack decision, and W073 typed-formatting intake"
        }),
        json!({
            "row_id": "service.w044_predecessor_bound",
            "state": "satisfied",
            "evidence_or_blocker": "W044 retained-history, retained-witness, alert, cross-engine, readiness, and exact blocker artifacts are predecessor inputs"
        }),
        json!({
            "row_id": "service.local_harness_register",
            "state": "satisfied_boundary",
            "evidence_or_blocker": "W045 emits a runnable local orchestration harness register, but it is not a daemon, endpoint, or recurring scheduler"
        }),
        json!({
            "row_id": "service.run_queue_manifest",
            "state": "satisfied_boundary",
        ...
        json!({
            "row_id": "service.retained_history_query_contract",
            "state": "satisfied_boundary",
            "evidence_or_blocker": "deterministic retained-history query contract and replay-correlation index are emitted as local evidence"
        }),
        json!({
            "row_id": "service.retained_witness_lifecycle_register",
            "state": "satisfied_boundary",
        ...
        json!({
            "row_id": "service.stage2_service_dependency_bound",
            "state": "satisfied",
            "evidence_or_blocker": "W045 Stage 2 service gate retains operated cross-engine differential service as an exact dependency"
        }),
        json!({
            "row_id": "service.oxfml_formatting_watch",
            "state": "satisfied",
    ...
    json!({
        "schema_version": W045_SERVICE_ENVELOPE_SCHEMA_V1,
        "run_id": run_id,
        "artifact_root": relative_artifact_root,
        "runner_kind": "local_harness_backed_operated_assurance_retained_history_witness_slo_alert_service",
        "runner_command": format!("cargo run -p oxcalc-tracecalc-cli -- operated-assurance {run_id}"),
        "file_backed_service_envelope_present": true,
        "local_harness_register_present": true,
        "service_run_queue_manifest_present": true,
        "operated_run_queue_present": false,
        "service_endpoint_present": false,
        "recurring_scheduler_present": false,
...
fn w045_operated_service_harness(
    run_id: &str,
    relative_artifact_root: &str,
    service_envelope: &Value,
) -> Value {
    let operations = vec![
        json!({
            "operation_id": "harness.source_evidence_index_load",
            "operation_kind": "artifact_ingest",
            "local_runnable": true,
            "result_state": "source_rows_available_for_packet"
        }),
        json!({
            "operation_id": "harness.service_envelope_write",
            "operation_kind": "artifact_emit",
            "local_runnable": true,
            "result_state": "service_envelope_written"
        }),
        json!({
            "operation_id": "harness.retained_history_query_emit",
            "operation_kind": "history_projection",
            "local_runnable": true,
            "result_state": "retained_history_query_rows_written"
        }),
        json!({
            "operation_id": "harness.replay_correlation_query_emit",
            "operation_kind": "history_projection",
            "local_runnable": true,
            "result_state": "replay_correlation_rows_written"
        }),
        json!({
            "operation_id": "harness.retained_witness_lifecycle_emit",
            "operation_kind": "witness_lifecycle_projection",
            "local_runnable": true,
            "result_state": "retained_witness_lifecycle_rows_written"
        }),
        json!({
            "operation_id": "harness.alert_dispatch_rule_eval",
            "operation_kind": "local_alert_rule_evaluation",
            "local_runnable": true,
            "result_state": "alert_rules_evaluated_without_external_dispatch"
        }),
        json!({
            "operation_id": "harness.cross_engine_service_classification",
            "operation_kind": "service_gate_classification",
            "local_runnable": true,
            "result_state": "cross_engine_service_dependency_classified"
        }),
        json!({
            "operation_id": "harness.no_proxy_promotion_guard",
            "operation_kind": "promotion_guard",
            "local_runnable": true,
            "result_state": "local_harness_not_counted_as_operated_endpoint"
        }),
    ];

    json!({
        "schema_version": W045_SERVICE_HARNESS_SCHEMA_V1,
        "run_id": run_id,
        "artifact_root": relative_artifact_root,
        "source_service_envelope_row_count": number_at(service_envelope, "row_count"),
        "local_harness_runnable": true,
        "local_process_only": true,
        "service_endpoint_present": false,
        "recurring_scheduler_present": false,
        "external_dispatcher_present": false,
        "retained_history_endpoint_present": false,
        "retained_witness_lifecycle_endpoint_present": false,
...
#[allow(clippy::too_many_arguments)]
fn w045_retained_history_service_query(
    run_id: &str,
    relative_artifact_root: &str,
    w044_retained: &Value,
    w045_residual_map: &Value,
    ...
    w044_pack_decision: &Value,
    w045_oxfml_inbound_intake: &Value,
    service_harness: &Value,
) -> Value {
    let mut rows = w044_retained
        .get("rows")
        .and_then(Value::as_array)
        .cloned()
        .unwrap_or_default();
    ...
    rows.push(history_row(
        next_order,
        "w045.residual_successor_obligation_map",
        "w045_residual_successor_obligation_map",
        "w045_operated_service_obligations_bound",
        W045_RESIDUAL_MAP,
        0,
        0,
        number_at(w045_residual_map, "source_residual_lane_count"),
    ));
    rows.push(history_row(
        next_order + 1,
        "w045.optimized_core_dynamic_transition",
        "w045_optimized_core_service_input",
        "dynamic_transition_evidence_bound_with_soft_reference_and_counterpart_blockers",
        W045_OPTIMIZED_SUMMARY,
        number_at(w045_optimized_summary, "failed_row_count"),
        0,
        number_at(w045_optimized_summary, "w045_exact_remaining_blocker_count"),
    ));
    rows.push(history_row(
        next_order + 2,
        "w045.rust_totality_refinement_bridge",
        "w045_rust_refinement_service_bridge",
        "rust_refinement_bridge_bound_with_totality_and_panic_surface_blockers",
        W045_RUST_SUMMARY,
        number_at(w045_rust_summary, "failed_row_count"),
        0,
        number_at(w045_rust_summary, "exact_remaining_blocker_count"),
    ));
    rows.push(history_row(
        next_order + 3,
        "w045.lean_tla_model_bound_bridge",
        "w045_lean_tla_model_bound_service_bridge",
        "bounded_lean_tla_model_bound_bridge_retained_with_fairness_blockers",
        W045_LEAN_TLA_SUMMARY,
        number_at(w045_lean_tla_summary, "failed_row_count"),
        0,
        number_at(w045_lean_tla_summary, "exact_remaining_blocker_count"),
    ));
    rows.push(history_row(
        next_order + 4,
        "w045.stage2_service_gate",
        "w045_stage2_service_gate",
        "stage2_service_gate_bound_with_cross_engine_retained_witness_and_pack_blockers",
        W045_STAGE2_SUMMARY,
        number_at(w045_stage2_summary, "failed_row_count"),
        0,
        number_at(w045_stage2_summary, "exact_remaining_blocker_count"),
    ));
    rows.push(history_row(
        next_order + 5,
        "w044.pack_c5_decision",
        "w044_pack_c5_service_blockers",
        "pack_c5_decision_retains_service_retained_witness_slo_and_program_grade_governance_blockers",
        W044_PACK_DECISION,
        0,
        0,
        array_len(&w044_pack_decision["no_promotion_reason_ids"]) as u64,
    ));
    rows.push(history_row(
        next_order + 6,
        "w045.local_service_harness",
        "w045_local_operated_service_harness",
        "local_harness_orchestration_recorded_without_operated_endpoint_promotion",
        W045_PROMOTION_CONTRACT_MAP,
        0,
        0,
        if bool_at(service_harness, "service_endpoint_present") {
            1
        } else {
            0
        },
    ...
    let mut query_register = w044_retained
        .get("query_register")
        .and_then(Value::as_array)
        .cloned()
        .unwrap_or_default();
    query_register.push(json!({
        "query_id": "history.by_w045_service_obligation",
        "query_kind": "join_service_rows_to_w045_successor_obligation_map",
        "result_source": W045_RESIDUAL_MAP,
        "deterministic": true
    }));
    query_register.push(json!({
        "query_id": "history.by_w045_stage2_service_gate",
        "query_kind": "join_history_rows_to_w045_stage2_service_gate",
        "result_source": W045_STAGE2_SERVICE_GATE,
        "deterministic": true
    }));
    query_register.push(json!({
        "query_id": "history.by_w045_proof_model_service_dependencies",
        "query_kind": "join_history_rows_to_w045_rust_and_lean_tla_proof_model_blockers",
        "result_source": W045_LEAN_TLA_BLOCKERS,
        "deterministic": true
    }));
    query_register.push(json!({
        "query_id": "history.by_w045_pack_and_retained_witness_gate",
        "query_kind": "join_history_rows_to_w044_pack_and_w045_retained_witness_dependencies",
        "result_source": W044_PACK_DECISION,
        "deterministic": true
    }));
    query_register.push(json!({
        "query_id": "history.by_w045_local_service_harness",
        "query_kind": "join_history_rows_to_local_harness_operations_without_endpoint_promotion",
        "result_source": W045_PROMOTION_CONTRACT_MAP,
        "deterministic": true
    }));

    let mut replay_correlation_index = w044_retained
        .get("replay_correlation_index")
        .and_then(Value::as_array)
        .cloned()
        .unwrap_or_default();
    replay_correlation_index.push(json!({
        "correlation_id": "corr.w045_service_obligations",
        "source_artifacts": [W045_RESIDUAL_MAP, W045_PROMOTION_CONTRACT_MAP],
        "w045_obligations": ["W045-OBL-023", "W045-OBL-024", "W045-OBL-025", "W045-OBL-026", "W045-OBL-027"],
        "replay_role": "operated_assurance_service_obligation_alignment"
    }));
    replay_correlation_index.push(json!({
        "correlation_id": "corr.w045_stage2_service_gate",
        "source_artifacts": [W045_STAGE2_SERVICE_GATE, W045_STAGE2_BLOCKERS],
        "w045_obligations": ["W045-OBL-022", "W045-OBL-025", "W045-OBL-036"],
        "replay_role": "stage2_service_gate_and_retained_witness_pack_dependency"
    }));
    replay_correlation_index.push(json!({
        "correlation_id": "corr.w045_proof_model_service_gate",
        "source_artifacts": [W045_RUST_SUMMARY, W045_LEAN_TLA_SUMMARY, W045_STAGE2_SUMMARY],
        "w045_obligations": ["W045-OBL-014", "W045-OBL-017", "W045-OBL-022"],
        "replay_role": "proof_model_rows_as_service_readiness_inputs_only"
    }));
    replay_correlation_index.push(json!({
        "correlation_id": "corr.w045_local_service_harness",
        "source_artifacts": [W045_PROMOTION_CONTRACT_MAP],
        "w045_obligations": ["W045-OBL-023", "W045-OBL-026", "W045-OBL-027"],
        "replay_role": "local_runnable_harness_orchestration_without_endpoint_promotion"
    }));
    replay_correlation_index.push(json!({
        "correlation_id": "corr.w045_w073_formatting_guard",
        "source_artifacts": [W045_OXFML_INBOUND_INTAKE],
        "w045_obligations": ["W045-OBL-003", "W045-OBL-031"],
        "replay_role": "observable_formatting_watch"
    }));

    json!({
        "schema_version": W045_RETAINED_HISTORY_SERVICE_SCHEMA_V1,
        "run_id": run_id,
        "artifact_root": relative_artifact_root,
        "history_kind": "w045_retained_history_query_contract_with_local_harness_retained_witness_slo_stage2_proof_model_and_formatting_watch",
        "file_backed_retained_history_store_present": true,
        "local_harness_runnable": bool_at(service_harness, "local_harness_runnable"),
        "retained_history_query_api_contract_present": true,
        "retained_history_query_register_present": true,
        "replay_correlation_index_present": true,
        "retained_history_service_operated": false,
        ...
        "source_history_row_count": number_at(w044_retained, "store_record_count"),
        "store_record_count": rows.len(),
        "query_register_row_count": query_register.len(),
        "replay_correlation_row_count": replay_correlation_index.len(),
        "promotion_contract_count": number_at(w045_promotion_contract_map, "promotion_contract_count"),
        "service_gate_row_count": number_at(w045_stage2_service_gate, "row_count"),
        "w073_threshold_fallback_allowed_for_typed_families": bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "threshold_fallback_allowed_for_typed_families"),
        "history_lifecycle_state": "local_harness_query_contract_extended_without_operated_retained_history_service",
        "rows": rows,
        "query_register": query_register,
        "replay_correlation_index": replay_correlation_index
    })
...
fn w045_retained_witness_lifecycle(
    run_id: &str,
    w044_witness: &Value,
    w045_stage2_decision: &Value,
    service_harness: &Value,
) -> Value {
    let mut rows = w044_witness
        .get("rows")
        .and_then(Value::as_array)
        .cloned()
        .unwrap_or_default();
    rows.push(json!({
        "row_id": "witness.w045_retention_slo_local_harness_gate",
        "source_artifact": W045_RESIDUAL_MAP,
        "lifecycle_state": "retention_slo_policy_declared_local_harness_observed_not_enforced",
        "local_harness_runnable": bool_at(service_harness, "local_harness_runnable"),
        "retention_slo_policy_declared": true,
        "retention_slo_enforced": false,
        "pack_eligible": false,
    ...
    rows.push(json!({
        "row_id": "witness.w045_stage2_retained_witness_pack_gate",
        "source_artifact": W045_STAGE2_DECISION,
        "lifecycle_state": "stage2_retained_witness_dependency_retained",
        "stage2_retained_witness_lifecycle_promoted": bool_at(w045_stage2_decision, "retained_witness_lifecycle_promoted"),
        "pack_grade_replay_promoted": bool_at(w045_stage2_decision, "pack_grade_replay_promoted"),
        "pack_eligible": false,
        "promotion_consequence": "pack-grade replay and C5 remain unpromoted"
    }));
    rows.push(json!({
        "row_id": "witness.w045_pack_grade_replay_governance_gate",
        "source_artifact": W045_STAGE2_DECISION,
        "lifecycle_state": "pack_governance_dependency_retained",
        "pack_grade_replay_governance_promoted": bool_at(w045_stage2_decision, "pack_grade_replay_governance_promoted"),
        "pack_eligible": false,
        "promotion_consequence": "pack-grade replay governance service remains unpromoted"
    }));
    rows.push(json!({
        "row_id": "witness.w045_no_proxy_pack_eligibility_guard",
        "source_artifact": W045_PROMOTION_CONTRACT_MAP,
        "lifecycle_state": "local_harness_not_pack_eligibility",
        "local_harness_runnable": bool_at(service_harness, "local_harness_runnable"),
        "service_endpoint_present": bool_at(service_harness, "service_endpoint_present"),
        "pack_eligible": false,
        "promotion_consequence": "local harness evidence cannot promote retained witnesses into pack-grade replay eligibility"
    }));
    ...
    json!({
        "schema_version": W045_RETAINED_WITNESS_SCHEMA_V1,
        "run_id": run_id,
        "retained_witness_lifecycle_register_present": true,
        "retained_witness_lifecycle_service_promoted": false,
        "retention_slo_policy_declared": true,
...
#[allow(clippy::too_many_arguments)]
fn w045_alert_dispatch_service(
    run_id: &str,
    w044_alerts: &Value,
    w044_promotion: &Value,
    w045_stage2_decision: &Value,
    ...
    let mut rows = w044_alerts
        .get("rows")
        .and_then(Value::as_array)
        .cloned()
        .unwrap_or_default();
    rows.push(json!({
        "rule_id": "quarantine.w045_unsupported_operated_service_claim",
        "action": "quarantine_run_and_block_service_promotion",
        "trigger": "any W044/W045 operated service, retained-history service, retained-witness service, external dispatcher, Stage 2 service, pack, C5, or release-grade promotion flag appears without operated service artifacts",
        "owner": "calc-zkio.6; calc-zkio.10; calc-zkio.11",
        "triggered": bool_at(w044_promotion, "operated_continuous_assurance_service_promoted")
            || bool_at(w044_promotion, "retained_history_service_promoted")
            || bool_at(w044_promotion, "retained_witness_lifecycle_service_promoted")
            || bool_at(w044_promotion, "retention_slo_enforcement_promoted")
            || bool_at(w044_promotion, "external_alert_dispatcher_promoted")
            || bool_at(w045_stage2_decision, "operated_cross_engine_stage2_service_promoted")
            || bool_at(w044_pack_decision, "capability_promoted"),
        "decision": "clean",
        "evidence": {
            "operated_continuous_assurance_service_promoted": bool_at(w044_promotion, "operated_continuous_assurance_service_promoted"),
            "retained_history_service_promoted": bool_at(w044_promotion, "retained_history_service_promoted"),
            "retained_witness_lifecycle_service_promoted": bool_at(w044_promotion, "retained_witness_lifecycle_service_promoted"),
            "retention_slo_enforcement_promoted": bool_at(w044_promotion, "retention_slo_enforcement_promoted"),
            "external_alert_dispatcher_promoted": bool_at(w044_promotion, "external_alert_dispatcher_promoted"),
            "operated_cross_engine_stage2_service_promoted": bool_at(w045_stage2_decision, "operated_cross_engine_stage2_service_promoted"),
            "pack_capability_promoted": bool_at(w044_pack_decision, "capability_promoted")
        }
    }));
    rows.push(json!({
        "rule_id": "quarantine.w045_local_harness_incomplete",
        "action": "quarantine_run_and_block_local_harness_claim",
        "trigger": "local service harness is absent or has fewer than eight deterministic operations",
        "owner": "calc-zkio.6",
        "triggered": !bool_at(service_harness, "local_harness_runnable")
            || number_at(service_harness, "operation_count") < 8,
        "decision": "clean",
        "evidence": {
            "local_harness_runnable": bool_at(service_harness, "local_harness_runnable"),
            "operation_count": number_at(service_harness, "operation_count")
        }
    }));
    rows.push(json!({
        "rule_id": "quarantine.w045_missing_retained_history_or_witness_contract",
        "action": "quarantine_run_and_block_pack_reassessment",
        "trigger": "retained-history query API contract, replay-correlation index, or retained-witness register is absent",
        "owner": "calc-zkio.6; calc-zkio.10",
        "triggered": !bool_at(retained_history, "retained_history_query_api_contract_present")
            || !bool_at(retained_history, "replay_correlation_index_present")
            || !bool_at(retained_witness_register, "retained_witness_lifecycle_register_present"),
        "decision": "clean",
    ...
    rows.push(json!({
        "rule_id": "quarantine.w045_stage2_operated_service_claim_without_service",
        "action": "quarantine_run_and_block_stage2_promotion",
        "trigger": "W045 Stage 2 claims operated cross-engine service or policy promotion while service readiness remains local-harness-only",
        "owner": "calc-zkio.6; calc-zkio.5; calc-zkio.10",
        "triggered": bool_at(w045_stage2_decision, "operated_cross_engine_stage2_service_promoted")
            || bool_at(w045_stage2_decision, "stage2_policy_promoted")
            || bool_at(w045_stage2_decision, "service_gate_promoted"),
        "decision": "clean",
        "evidence": {
            "operated_cross_engine_stage2_service_promoted": bool_at(w045_stage2_decision, "operated_cross_engine_stage2_service_promoted"),
            "stage2_policy_promoted": bool_at(w045_stage2_decision, "stage2_policy_promoted"),
            "service_gate_promoted": bool_at(w045_stage2_decision, "service_gate_promoted")
        }
    }));
    rows.push(json!({
        "rule_id": "alert.w045_retention_slo_not_enforced",
        "action": "record_retention_slo_blocker_without_dispatch",
        "trigger": "retention SLO policy is declared but not enforced by an operated service",
        "owner": "calc-zkio.6; calc-zkio.10",
        "triggered": false,
    ...
    rows.push(json!({
        "rule_id": "alert.w045_local_harness_not_service_endpoint",
        "action": "record_local_harness_boundary_without_dispatch",
        "trigger": "local harness is runnable but has no daemon, queue, external dispatcher, or retained-history endpoint",
        "owner": "calc-zkio.6",
        "triggered": false,
        "decision": "clean",
        "evidence": {
            "local_harness_runnable": bool_at(service_harness, "local_harness_runnable"),
            "service_endpoint_present": bool_at(service_harness, "service_endpoint_present"),
            "external_dispatcher_present": bool_at(service_harness, "external_dispatcher_present"),
            "retained_history_endpoint_present": bool_at(service_harness, "retained_history_endpoint_present")
        }
    }));
    rows.push(json!({
        "rule_id": "quarantine.w045_w073_old_string_fallback_claim",
        "action": "quarantine_run_and_open_oxfml_seam_handoff",
        "trigger": "W045 evidence claims W072 bounded threshold strings still define aggregate or visualization metadata for W073 families",
        "owner": "calc-zkio.6; calc-zkio.8",
        "triggered": bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "threshold_fallback_allowed_for_typed_families"),
        "decision": "clean",
        "evidence": {
            "threshold_fallback_allowed_for_typed_families": bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "threshold_fallback_allowed_for_typed_families"),
            "old_bounded_string_non_interpretation_evidence_reviewed": bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "old_bounded_string_non_interpretation_evidence_reviewed")
        }
    }));
    ...
    json!({
        "schema_version": W045_ALERT_DISPATCH_SCHEMA_V1,
        "run_id": run_id,
        "policy_source": W044_ALERT_DISPATCH_SERVICE,
        "policy_state": "w045_local_alert_dispatch_service_contract_evaluated_without_external_dispatcher_promotion",
        "evaluated_rule_count": rows.len(),
        "quarantine_decision_count": quarantine_decision_count,
        "alert_decision_count": alert_decision_count,
        "clean_rule_count": rows.len() - quarantine_decision_count - alert_decision_count,
...
fn w045_cross_engine_service(
    ...
    json!({
        "schema_version": W045_CROSS_ENGINE_SERVICE_SCHEMA_V1,
        "run_id": run_id,
        "file_backed_cross_engine_substrate_present": bool_at(w044_cross_engine, "file_backed_cross_engine_substrate_present"),
        "w044_stage2_service_dependency_blocker_present": bool_at(w044_cross_engine, "w044_stage2_service_dependency_blocker_present"),
        "w045_stage2_policy_row_count": number_at(w045_stage2_summary, "policy_row_count"),
        "w045_stage2_service_gate_row_count": number_at(w045_stage2_service_gate, "row_count"),
        "w045_stage2_service_dependency_blocker_present": row_with_field_exists(
            w045_stage2_blockers,
            "row_id",
            "w045_stage2_operated_cross_engine_service_dependency_blocker"
        ),
        ...
        "operated_cross_engine_differential_service_promoted": false,
        "service_endpoint_present": false,
        "service_state": "file_backed_cross_engine_substrate_and_w045_stage2_service_gate_bound_without_operated_service",
        "blocked_service_claims": [
            "recurring_cross_engine_diff_scheduler",
            "cross_engine_service_endpoint",
            "operated_mismatch_quarantine_dispatcher",
...
fn w045_service_readiness(
    ...
    let criteria = vec![
        criterion(
            "readiness.w045_service_envelope_present",
            "satisfied",
            "W045 emits a service envelope through the checked runner",
        ),
        criterion(
            "readiness.w045_source_evidence_index_bound",
            "satisfied",
            "W045 source index binds W045 residual obligations, W044 service evidence, W045 proof/model evidence, W045 Stage 2 service gates, W044 pack blockers, and W073 formatting intake",
        ),
        criterion(
            "readiness.w045_local_harness_runnable",
            "satisfied_boundary",
            "local harness register is runnable for artifact orchestration but not an operated service endpoint",
        ),
        criterion(
            "readiness.w045_local_harness_operation_set",
            "satisfied",
            "local harness records eight deterministic operations for source, history, witness, alert, cross-engine, and no-proxy guard orchestration",
        ),
        criterion(
            "readiness.w045_run_queue_manifest_declared",
            "satisfied_boundary",
            "service-readable run queue manifest is declared in the envelope, but not operated as a scheduler",
        ),
        criterion(
            "readiness.w045_retained_history_query_contract_present",
            "satisfied_boundary",
            "deterministic retained-history query API contract is emitted with store and query rows",
        ),
        criterion(
            "readiness.w045_replay_correlation_index_present",
            "satisfied",
            "replay-correlation rows are emitted for W045 service obligations, Stage 2 service gates, proof/model inputs, local harness, and W073 guard evidence",
        ),
        criterion(
            "readiness.w045_retained_witness_lifecycle_register_present",
            "satisfied_boundary",
            "retained-witness lifecycle rows are registered without pack eligibility promotion",
        ),
        criterion(
            "readiness.w045_retention_slo_policy_declared",
            "satisfied_boundary",
            "retention SLO policy is declared for retained-history and retained-witness lifecycle evidence",
        ),
        criterion(
            "readiness.w045_alert_dispatch_contract_evaluated",
            "satisfied",
            "local alert/quarantine dispatch contract is evaluated against service, retained-history, retained-witness, Stage 2, pack, proof/model, harness, and W073 inputs",
        ),
        criterion(
            "readiness.w045_no_quarantine_decisions",
            "satisfied",
            "W045 local dispatch contract and source evidence produce no quarantine decisions",
        ),
        criterion(
            "readiness.w045_cross_engine_substrate_bound",
            "satisfied_boundary",
            "W045 binds file-backed cross-engine substrate and Stage 2 service dependency without service promotion",
        ),
        criterion(
            "readiness.w045_optimized_core_service_input_bound",
            "satisfied",
            "W045 dynamic transition evidence is bound as service-readiness input only",
        ),
        criterion(
            "readiness.w045_rust_refinement_bridge_bound",
            "satisfied",
            "W045 Rust refinement rows are bound as service-readiness input only",
        ),
        criterion(
            "readiness.w045_lean_tla_model_bound_bridge_bound",
            "satisfied_boundary",
            "W045 Lean/TLA bounded model rows are bound without promoting fairness or unbounded coverage",
        ),
        criterion(
            "readiness.w045_stage2_service_gate_classified",
            "satisfied",
            "W045 Stage 2 service gate retains operated cross-engine service as an exact dependency",
        ),
        criterion(
            "readiness.w045_retained_witness_pack_dependency_classified",
            "satisfied",
            "W045 Stage 2 retains retained-witness lifecycle and retention SLO as exact pack-grade replay dependencies",
        ),
        criterion(
            "readiness.w045_pack_governance_dependency_classified",
            "satisfied",
            "W045 Stage 2 and W044 pack decision retain pack-grade replay governance as a no-promotion dependency",
        ),
        criterion(
            "readiness.w045_w044_pack_service_blockers_bound",
            "satisfied",
            "W044 pack/C5 reassessment retains retained-history, retained-witness, retention SLO, alert, cross-engine, and pack-governance service blockers",
        ),
        criterion(
            "readiness.w045_w073_typed_formatting_guard_retained",
            "satisfied",
            "W045 carries OxFml W073 typed_rule-only aggregate/visualization formatting guard and old-string non-interpretation evidence",
        ),
        criterion(
            "readiness.w045_downstream_w073_request_construction_unverified",
            "satisfied_boundary",
            "downstream typed-rule request construction remains required but unverified by OxCalc and is routed to calc-zkio.8",
        ),
        criterion(
            "readiness.w045_no_proxy_service_promotion_guard",
            "satisfied",
            "file-backed and local-harness-only artifacts are not counted as operated service, pack, Stage 2, C5, or release-grade promotions",
        ),
        criterion(
            "readiness.w045_local_harness_endpoint_boundary",
            "satisfied_boundary",
            "local harness is runnable but explicitly records no service endpoint, daemon, external dispatcher, retained-history endpoint, or retained-witness lifecycle endpoint",
        ),
        criterion(
            "readiness.w045_retained_history_query_rows_extended",
            "satisfied",
            "retained-history store, query-register, and replay-correlation rows are extended beyond W044 with W045 service and harness evidence",
        ),
        criterion(
            "readiness.w045_retained_witness_lifecycle_rows_extended",
            "satisfied_boundary",
            "retained-witness lifecycle rows are extended beyond W044 while keeping pack eligibility at zero",
        ),
        criterion(
            "service.operated_scheduler_service_endpoint",
            "blocked",
            "local harness and run queue manifest are present, but no recurring scheduler, daemon, service endpoint, or operated queue exists",
        ),
        criterion(
            "service.retained_history_service_endpoint",
            "blocked",
            "retained-history query contract is local-harness-backed and not an operated retained-history service endpoint",
        ),
        criterion(
            "service.retained_witness_lifecycle_service_slo",
            "blocked",
        ...
        criterion(
            "service.pack_grade_replay_governance",
            "blocked",
            "pack-grade replay governance service remains unpromoted and cannot be inferred from local retained-history, retained-witness, or harness artifacts",
        ),
    ];
    let blocked_criteria_count = criteria
        .iter()
    ...
    json!({
        "schema_version": W045_SERVICE_READINESS_SCHEMA_V1,
        "run_id": run_id,
        "artifact_root": relative_artifact_root,
        "readiness_state": "w045_service_packet_validated_with_local_harness_without_operated_service_promotion",
        "criteria_count": criteria.len(),
        "satisfied_criteria_count": criteria.len() - blocked_criteria_count,
        "blocked_criteria_count": blocked_criteria_count,
        "service_envelope_row_count": number_at(service_envelope, "row_count"),
        ...
        "file_backed_cross_engine_substrate_present": bool_at(cross_engine_service, "file_backed_cross_engine_substrate_present"),
        "stage2_policy_promoted": bool_at(w045_stage2_decision, "stage2_policy_promoted"),
        "w073_typed_rule_only_formatting_guard_carried": array_len(&w045_oxfml_inbound_intake["w073_formatting"]["typed_rule_only_families"]) == 7
            && !bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "threshold_fallback_allowed_for_typed_families")
            && bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "old_bounded_string_non_interpretation_evidence_reviewed"),
        "w073_downstream_typed_rule_request_construction_required": bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "downstream_typed_rule_request_construction_required"),
        "w073_downstream_typed_rule_request_construction_verified": bool_at(&w045_oxfml_inbound_intake["w073_formatting"], "downstream_uptake_verified_by_oxcalc"),
...
fn w045_exact_service_blockers() -> Vec<Value> {
    vec![
        json!({
            "blocker_id": "service.operated_scheduler_service_endpoint_absent",
            "owner": "calc-zkio.6; calc-zkio.10",
            "status_after_run": "exact_remaining_blocker",
            "reason": "W045 emits a runnable local harness and run queue manifest, but no recurring scheduler, daemon, service endpoint, or operated run queue.",
            "promotion_consequence": "operated continuous assurance service remains unpromoted"
        }),
        json!({
            "blocker_id": "service.retained_history_service_endpoint_absent",
            "owner": "calc-zkio.6; calc-zkio.10",
            "status_after_run": "exact_remaining_blocker",
            "reason": "W045 emits retained-history query rows and a local harness operation, but no operated retained-history service endpoint or retention lifecycle service.",
            "promotion_consequence": "retained-history service and pack-grade replay governance remain unpromoted"
        }),
        json!({
            "blocker_id": "service.retained_witness_lifecycle_service_slo_absent",
            "owner": "calc-zkio.6; calc-zkio.10",
            "status_after_run": "exact_remaining_blocker",
            "reason": "W045 carries retained-witness lifecycle rows and declares a retention SLO policy, but no lifecycle service or SLO enforcement exists.",
            "promotion_consequence": "retained-witness lifecycle service, retention SLO enforcement, pack-grade replay, C5, and release-grade verification remain unpromoted"
        }),
        json!({
            "blocker_id": "service.external_alert_dispatcher_absent",
            ...
            "status_after_run": "exact_remaining_blocker",
            "reason": "W045 evaluates alert/quarantine dispatch rules locally and records an external dispatcher contract, but no external dispatcher or quarantine service is operated.",
            "promotion_consequence": "alert/quarantine dispatcher and mismatch quarantine service claims remain unpromoted"
        }),
        json!({
            "blocker_id": "service.operated_cross_engine_differential_absent",
        ...
        json!({
            ...
            "owner": "calc-zkio.6; calc-zkio.10",
            "status_after_run": "exact_remaining_blocker",
            "reason": "W045 retained-history, retained-witness, and harness rows are deterministic local artifacts, but no pack-grade replay governance service binds them into a program-grade retained-witness lifecycle.",
            "promotion_consequence": "pack-grade replay, C5, and release-grade verification remain unpromoted"
        }),
    ]
}
...
fn failed_rows_in_register(value: &Value) -> u64 {
    value
        .get("rows")
        .and_then(Value::as_array)
        .into_iter()
...
mod tests {
    ...
    #[test]
    fn operated_assurance_runner_binds_w044_service_packet_without_promotion() {
        let repo_root = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
            .join("../..")
            .canonicalize()
            .unwrap();
        let run_id = format!("test-w044-operated-assurance-{}", std::process::id());
        let artifact_root = repo_root.join(format!(
            "docs/test-runs/core-engine/operated-assurance/{run_id}"
        ));
        let cleanup = || {
        ...
        assert_eq!(summary.multi_run_history_row_count, 40);
        assert_eq!(summary.evaluated_alert_rule_count, 35);
        assert_eq!(summary.quarantine_decision_count, 0);
        assert_eq!(summary.alert_decision_count, 0);
        assert_eq!(summary.service_readiness_criteria_count, 25);
        assert_eq!(summary.service_readiness_blocked_count, 6);
        assert_eq!(summary.exact_service_blocker_count, 6);
        assert_eq!(summary.failed_row_count, 0);
        assert!(!summary.operated_service_promoted);
        ...
        let retained_history = read_json(
            &repo_root,
            &format!(
                "docs/test-runs/core-engine/operated-assurance/{run_id}/w044_retained_history_service_query.json"
            ),
        )
        .unwrap();
        assert_eq!(
        ...
        let retained_witness = read_json(
            &repo_root,
            &format!(
                "docs/test-runs/core-engine/operated-assurance/{run_id}/w044_retained_witness_lifecycle_register.json"
            ),
        )
        .unwrap();
        assert_eq!(
        ...
        let readiness = read_json(
            &repo_root,
            &format!(
                "docs/test-runs/core-engine/operated-assurance/{run_id}/w044_service_readiness_register.json"
            ),
        )
        .unwrap();
        assert_eq!(
        ...
        assert_eq!(
            readiness["w073_downstream_typed_rule_request_construction_verified"],
            false
        );
        assert_eq!(readiness["retention_slo_enforcement_promoted"], false);
        ...
        let blocker_register = read_json(
            &repo_root,
            &format!(
                "docs/test-runs/core-engine/operated-assurance/{run_id}/w044_exact_service_blocker_register.json"
            ),
        )
        .unwrap();
        assert_eq!(blocker_register["exact_service_blocker_count"], 6);
    ...
    #[test]
    fn operated_assurance_runner_binds_w045_local_harness_without_service_promotion() {
        let repo_root = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
            .join("../..")
            .canonicalize()
            .unwrap();
        let run_id = format!("test-w045-operated-assurance-{}", std::process::id());
        let artifact_root = repo_root.join(format!(
            "docs/test-runs/core-engine/operated-assurance/{run_id}"
        ));
        let cleanup = || {
        ...
        assert_eq!(summary.source_evidence_row_count, 20);
        assert_eq!(summary.multi_run_history_row_count, 47);
        assert_eq!(summary.evaluated_alert_rule_count, 42);
        assert_eq!(summary.quarantine_decision_count, 0);
        assert_eq!(summary.alert_decision_count, 0);
        assert_eq!(summary.service_readiness_criteria_count, 31);
        assert_eq!(summary.service_readiness_blocked_count, 6);
        assert_eq!(summary.exact_service_blocker_count, 6);
        assert_eq!(summary.failed_row_count, 0);
        assert!(!summary.operated_service_promoted);
        ...
        assert_eq!(validation["service_harness_operation_count"], 8);
        assert_eq!(validation["query_register_row_count"], 22);
        assert_eq!(validation["replay_correlation_row_count"], 20);
        assert_eq!(validation["retained_witness_lifecycle_row_count"], 15);

        let harness = read_json(
            &repo_root,
            &format!(
                "docs/test-runs/core-engine/operated-assurance/{run_id}/w045_operated_service_harness_register.json"
            ),
        )
        .unwrap();
        assert_eq!(harness["local_harness_runnable"], true);
        assert_eq!(harness["operation_count"], 8);
        assert_eq!(harness["service_endpoint_present"], false);
        assert_eq!(harness["external_dispatcher_present"], false);

        let retained_history = read_json(
            &repo_root,
            &format!(
                "docs/test-runs/core-engine/operated-assurance/{run_id}/w045_retained_history_service_query.json"
            ),
        )
        .unwrap();
        assert_eq!(
        ...
        let retained_witness = read_json(
            &repo_root,
            &format!(
                "docs/test-runs/core-engine/operated-assurance/{run_id}/w045_retained_witness_lifecycle_register.json"
            ),
        )
        .unwrap();
        assert_eq!(
        ...
        let readiness = read_json(
            &repo_root,
            &format!(
                "docs/test-runs/core-engine/operated-assurance/{run_id}/w045_service_readiness_register.json"
            ),
        )
        .unwrap();
        assert_eq!(readiness["local_harness_runnable"], true);
        assert_eq!(
            readiness["w073_typed_rule_only_formatting_guard_carried"],
            true
        );
        ...
        .unwrap();
        assert_eq!(promotion["local_operated_service_harness_runnable"], true);
        assert_eq!(promotion["retained_history_service_promoted"], false);
        assert_eq!(
            promotion["retained_witness_lifecycle_service_promoted"],
            false
        ...
        let blocker_register = read_json(
            &repo_root,
            &format!(
                "docs/test-runs/core-engine/operated-assurance/{run_id}/w045_exact_service_blocker_register.json"
            ),
        )
        .unwrap();
        assert_eq!(blocker_register["exact_service_blocker_count"], 6);
